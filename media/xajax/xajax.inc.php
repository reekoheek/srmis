...
class xajax
{
	...
	function xajax($sRequestURI="",$sWrapperPrefix="xajax_",$sEncoding=XAJAX_DEFAULT_CHAR_ENCODING,$bDebug=false)
	{
		...
		$this->sLogFile = "../../ref/xajax_error_log.log";
		$this->bCleanBuffer = false;
		$this->setCharEncoding($sEncoding);
		$this->bDecodeUTF8Input = false;
		$this->bOutputEntities = true;
		$this->tantosShowLoading = true;
		//$this->tantosShowStatusSimpan = true;
	}
	...
	function getJavascriptConfig()
	{
		...
		//$html .= "var tantosShowStatusSimpan=" . $this->tantosShowStatusSimpan . ";\n";
		...
		$html .= "var tantosShowLoading=" . ($this->tantosShowLoading?"true":"false") . ";\n";
