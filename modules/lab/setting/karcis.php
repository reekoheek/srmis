...
Class BHP {
	...
	function list_data($hal = 0) {
		...
		$tabel->addTh("No", "Nama", "Jenis", "Kelas", "BHP", "Jasa", "bhp p", "bhp rs", "bhp rs adm", "bhp rs op", "jasa p", "jasa rs", "jasa rs op", "jasa rs kembang", "jasa rs adm", "jasa rs sdm", "spesialis", "spesialis pendamping", "ugp", "grabaf", "perawat", "penunjang", "zakat", "pajak", "netto", "Hapus");
