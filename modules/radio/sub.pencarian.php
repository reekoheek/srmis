...
Class Cari_Pasien {
	...
	function hapus_pasien_confirm($id, $nama) {
		$objResponse = new xajaxResponse();
		$objResponse->addConfirmCommands(1, "Yakin akan menghapus data : \n$nama?");
		$objResponse->addScriptCall("xajax_hapus_pasien", $id);
		return $objResponse;
	}
...
$_xajax->registerFunction(array("hapus_pasien_confirm", "Cari_Pasien", "hapus_pasien_confirm"));
