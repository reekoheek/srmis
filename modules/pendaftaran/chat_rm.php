...
Class InfoBar {
    ...
    function get_jml_rm() {
       ...
       //  $objResponse->addAssign("infobar_rajal", "innerHTML", "&mdash; Pasien Rawat Jalan &mdash; ");       
		$objResponse->addAssign("infobar_jml_pasien_rm", "innerHTML", $ret);
		return $objResponse;
	}
...
$_xajax->registerFunction(array("get_jml_rm", "InfoBar", "get_jml_rm"));
