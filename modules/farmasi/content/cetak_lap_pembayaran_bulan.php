...
<table border="0" cellpadding="2" cellspacing="2" width="800px" align="center">
	<tr>
		<td align="center" colspan="4"><font color="#000000" size="+1"><strong>LAPORAN PEMBAYARAN COPY RESEP BARANG PER BULAN<br></strong></font></td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="4" align="center">
			...
			$q3=mysql_query("SELECT SUM(jumlah_harga) FROM lunas WHERE month = '".$_POST['month']."' 
			AND year = '".$_POST['year']."'");
