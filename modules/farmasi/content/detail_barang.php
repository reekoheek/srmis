				...
				<tr>
					...
					<table border="0" cellpadding="2" cellspacing="2" width="100%">
						...
						<tr>
						  ...
						  <td><input type="text" name="no_batch" size="5" value="<?= $r['no_batch']?>" readonly="true"></td>
						  <td align="right">Expire Date : </td>
						  <td><INPUT name="expire_date" readonly="true" value="<?= $r['expire_date']?>"></td>
					  </tr>
						<tr>
							<td align="right">No Rak </td>
							<td><input type="text" name="no_rak" size="5" value="<?= $r['no_rak']?>" readonly="true"></td>
							<td align="right">&nbsp;</td>
							<td>&nbsp;</td>
						</tr>
						<tr>
						...
						<tr>
						  ...
						  <td><input type="text" name="harga_dosp" size="15" value="<?= $r['harga_dosp']?>" readonly="true"></td>
					  </tr>
						<tr>
						...
						<tr>
						  ...
						  <td align="right">Stok</td>
							<td><input type="text" name="stok" value="<?=$r['stok']?>" readonly="true" size="7"></td>
						</tr>
						<tr>
						  ...
						  <td align="right">Stok Min : </td>
							<td><input type="text" name="stok_min" size="7" value="<?= $r['stok_min']?>" readonly="true"></td>
						</tr>
						<tr>
                          ...
                          <td><input type="text" name="stok_max" size="7" value="<?= $r['stok_max']?>" readonly="true"></td>
					  </tr>
						<tr>
