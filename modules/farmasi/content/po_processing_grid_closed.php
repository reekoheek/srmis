        ...
        while ($exQueryDet = mysql_fetch_assoc($temp)){
            ...
            foreach ($toField as $key => $val){
                ...
                print "<td align='center'>
                      ...
                      ";
        ?>
                <input type ='text' maxlength='5' size=8 name='txtSat<?=$no?>' value='<?=$exQueryDet[po_satuan]?>' readonly='true'/></td>
                <td align='center'><input type ='text' maxlength='4' size=8 name='txtQty<?=$no?>' readonly='true' value='<?=$exQueryDet[po_qty]?>' /></td>
                <td align='center'><input type ='text' maxlength='9' size=10 name='txtHarga<?=$no?>' readonly='true' value='<?=$exQueryDet[po_harga]?>' /> </td>
                <td align='center'><input type ='text' maxlength='3' size=5 name='txtDisc<?=$no?>' readonly='true' value='<?=$exQueryDet[po_discount]?>'/></td>
                <td align='center'><input type ='text' name='txtADisc<?=$no?>' size=15 readonly='true' value='<?=$exQueryDet[po_discammount]?>' /></td>
