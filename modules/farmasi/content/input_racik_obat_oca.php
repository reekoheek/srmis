		...
		<td id="" >
			...
			<table border="0" cellpadding="0" cellspacing="0" width="70%">
				<tr>
					...
					<form method="post" enctype="multipart/form-data" action="../action/insert_detail_racik_obat_oca.php">
					...
					<table border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td>
							<form method="post" enctype="multipart/form-data" action="home.php?hal=content/daftar_racik_obat_oca">
