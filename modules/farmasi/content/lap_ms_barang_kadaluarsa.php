...
$namaFile = "lap_ms_barang_kadaluarsa.xls";
...
xlsWriteLabel(0,0,"DAFTAR BARANG GUDANG UTAMA KADALUARSA");
...
xlsWriteLabel(1,3,"STOK");   

// mengisi pada cell A5 (baris ke-0, kolom ke-4)
xlsWriteLabel(1,4,"EXPIRE"); 
xlsWriteLabel(1,5,"HARGA"); 
...
$query = "SELECT * FROM ms_barang WHERE flags='9' ORDER BY ex_year,ex_month,ex_year ASC";
