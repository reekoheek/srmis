...
<table border="0" cellpadding="2" cellspacing="2" width="800px" align="center">
	<tr>
		<td align="center" colspan="4"><font color="#000000" size="+1"><strong>LAPORAN COPY RESEP BARANG PER HARI<br></strong></font></td>
	</tr>
	<tr>
		<td width="240">Tanggal : <?=$_POST['date'] . "-" .$_POST['month']. "-" .$_POST['year'] ?></td>
	...
	<tr>
		<td colspan="4" align="center">
			<?php
			$query = mysql_query("SELECT * FROM obat,copy_resep,pasien WHERE obat.kode_obat = copy_resep.kode_obat AND copy_resep.no_rm = pasien.no_rm  
			AND date = '".$_POST['date']."' AND month = '".$_POST['month']."' AND year = '".$_POST['year']."'");
			echo '<table border=1 cellpadding=2 cellspacing=2 width=100% bordercolor=#FF9933>
					<tr bgcolor=#FEFAFA align=center>
						...
						<td><font color=#000000>No RM</font></td>
			...
			$q3=mysql_query("SELECT SUM(jumlah_harga) FROM copy_resep WHERE date = '".$_POST['date']."' AND month = '".$_POST['month']."' 
			AND year = '".$_POST['year']."'");
