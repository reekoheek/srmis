			...
			<table border="0" cellpadding="0" cellspacing="0" width="70%">
				<tr>
					...
					<table border="0" cellpadding="2" cellspacing="2" width="100%">
						...
						<input type="hidden" name="kd_barang" value="<?= $rb['kd_barang']?>">
						<input type="hidden" name="id_ms" value="<?= $rb['id']?>">
						<tr>
						...
						<tr>
							<?php
								$qs = mysql_query("SELECT * FROM satuan WHERE kd_satuan = '$rb[satuan]'");
						...
						<tr>
							...
							<td><input type="text" name="expired" value="<?=$rb['expire_date']?>" size="12" readonly="true"></td>
						</tr>
						<tr>
							<td align="left" width="200">Stok Gudang Farmasi :</td>
							<td><input type="text" name="expired" value="<?=$rb['stok']?>" size="5" readonly="true" disabled="disabled"></td>
						</tr>
						<tr>
					...
					<table border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td>
							<form method="post" enctype="multipart/form-data" action="home.php?hal=content/daftar_permintaan_obat">
