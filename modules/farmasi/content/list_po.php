...
*/
                                                ...
                                                <td align=center><input type='hidden' name='stream' value='$stream' />");
                                                if ($fetchHeader['status']==1){
                                                    echo "<input type='submit' name='submit' value='View PO' id='submit' />";
                                                }else{
                                                    echo "<input type='submit' name='submit' value='Process PO' id='submit' /> " ;}                                                
