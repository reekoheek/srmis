				...
				<tr>
					...
					<tr valign="top">
						...
						<?php
							...
							if ($cari)
							{
								$query_rec  = mysql_query ("SELECT * FROM stok_level,ms_barang WHERE stok_level.barang_id = ms_barang.id AND ms_barang.kd_barang LIKE '$cari%' AND ms_barang.flags <> '9' ORDER BY stok_level.barang_id ASC");
							}
							else
							{
								$query_rec  = mysql_query ("SELECT * FROM stok_level,ms_barang WHERE stok_level.barang_id = ms_barang.id AND ms_barang.flags <> '9' ORDER BY stok_level.barang_id ASC");
							}
							$rec=0;
						...
						<tr>
							<td>
								<?php
									...
									if ($cari)
									{
									$query  = mysql_query ("SELECT * FROM stok_level,ms_barang WHERE stok_level.barang_id = ms_barang.id AND ms_barang.kd_barang LIKE '$cari%' AND ms_barang.flags <> '9' ORDER BY stok_level.barang_id ASC");
									}
									else
									{
									$query  = mysql_query ("SELECT * FROM stok_level,ms_barang WHERE stok_level.barang_id = ms_barang.id AND ms_barang.flags <> '9' ORDER BY stok_level.barang_id ASC LIMIT $offset, $rowsPerPage");
									}
									...
									$query   = "SELECT COUNT(stok_level.id) AS numrows FROM stok_level,ms_barang WHERE stok_level.barang_id=ms_barang.id AND ms_barang.flags<>'9' ORDER BY stok_level.barang_id ASC";
