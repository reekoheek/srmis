		...
		<td id="" >
			...
			<table border="0" cellpadding="0" cellspacing="0" width="70%">
				<tr>
					...
					<form method="post" enctype="multipart/form-data" action="../action/insert_detail_racik_obat_lab.php">
					<table border="0" cellpadding="2" cellspacing="2" width="100%">
						...
						<tr>
							...
							<td>
							<input type="text" name="stok" size="7" disabled="true"  id="inputString2" onKeyUp="lookup(this.value);" onblur="fill();">
							<input type="hidden" name="kd_obatt" size="7"  id="inputString3" onKeyUp="lookup(this.value);" onblur="fill();"><div class="suggestionsBox" id="suggestions" style="display: none;" align="left"> <img src="upArrow.png" style="position: relative; top: -18px; left: 0px; right:150px;" alt="upArrow" />
								  <div class="suggestionList" id="autoSuggestionsList"></div>
							  </div>
					      </div></td>
						</tr>
					...
					<table border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td>
							<form method="post" enctype="multipart/form-data" action="home.php?hal=content/daftar_racik_obat_lab">
