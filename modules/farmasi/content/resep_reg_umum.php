					...
					<table border="0" cellpadding="2" cellspacing="2" width="100%">
						...
						<tr>
							...
							?>
								...
								?>
								<input type="hidden" value="<?= $keterangan?>" name="jenis_keterangan">
							</td>
							<?php
								}
							?>
					  ...
					  <input type="hidden" name="jenis_ket" value="<?=$jenis_ket?>">
...
echo "</td>
										...
										echo "</td>
											...
											if ($r['racikan']=='YA')
											{
											echo"<a href=\"home.php?hal=action/hapus_resep_reg_umum&jenis_ket=$jenis_ket&no_ket=$no_ket&kd_barang=$r[kode_obat]&diberi=$r[diberi]&no_resep=$no_resep&param_no=$param_no&nama=$nama_pasien&id=$r[id]\" 
