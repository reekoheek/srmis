		...
		<td id="tengah_isi" >
			...
			<table border="0" cellpadding="0" cellspacing="0" width="85%">
				<tr>
					...
					<form method="post" enctype="multipart/form-data" action="home.php?hal=action/insert_resep_reg_umum">
					<table border="0" cellpadding="2" cellspacing="2" width="100%">
						...
						<tr>
							<td align="left" width="200px"><font color="#FF0000"></font> </td>
							<td><input type="hidden" name="kd_obatt" size="40"  id="inputString3" onKeyUp="lookup(this.value);" onblur="fill();"><div class="suggestionsBox" id="suggestions" style="display: none;" align="left"> <img src="upArrow.png" style="position: relative; top: -18px; left: 0px; right:150px;" alt="upArrow" />
								  <div class="suggestionList" id="autoSuggestionsList"></div>
							  </div>
					      </div></td>
						</tr>
						<tr><td>Stok :</td>
						<td><input type="text" name="stok" size="7" disabled  id="inputString2" onKeyUp="lookup(this.value);" onblur="fill();"><div class="suggestionsBox" id="suggestions" style="display: none;" align="left">
							</td>
						</tr>
					...
					<table border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td>
							<form method="post" enctype="multipart/form-data" action="home.php?hal=content/daftar_obat_umum">
