								...
								<?php
									...
									while ($r = mysql_fetch_array($q))
									{
										...
										echo "</td>
											...
											<a href=\"home.php?hal=action/hapus_racik_obat_rawat_jalan&fld02=$fld02&qty=$r[qty]&no_racik=$no_racik&id=$r[id]&pasien_id=$pasien_id&kd_barang=$r[kode_obat]&diberi=$r[diberi]&no_resep=$no_resep&param_no=$param_no\" 
