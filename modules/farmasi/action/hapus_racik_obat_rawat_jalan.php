...
if($result){
print "<script>alert('Data Berhasil di Hapus.');location.href='home.php?hal=content/racik_obat_rawat_jalan&fld02=$fld02&no_racik=$no_racik&pasien_id=$pasien_id&id=$id&no_resep=$no_resep&nama=$nama'</script>";
}
