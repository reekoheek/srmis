...
print "<script>location.href='home.php?hal=content/racik_obat_rawat_inap&no_resep=$no_resep&pasien_id=$pasien_id&no_racik=$no_racik&param_no=$param_no&nama=$nama'</script>";
?>