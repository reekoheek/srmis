<?php
	...
	print "<script>location:PopupCenter('content/input_racik_obat_radiologi.php?no_racik=$no_racik&pasien_id=$pasien_id&param_no=$param_no&no_resep=$no_resep&fld02=$fld02&nama=$nama&pop=0', 'myPop1',800,400);</script>";

	print "<script>location='home.php?hal=content/racik_obat_radiologi&no_racik=$no_racik&pasien_id=$pasien_id&param_no=$param_no&no_resep=$no_resep&fld02=$fld02&nama=$nama&pop=$pop'</script>";
?>