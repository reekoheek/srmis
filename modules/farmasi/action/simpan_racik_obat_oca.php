<?php
	...
	print "<script>alert('Data Telah Di Simpan .');location.href='home.php?hal=content/resep_reg_oca&no_racik=$no_racik&id=$pasien_id&pasien_id=$pasien_id&param_no=$param_no&no_resep=$no_resep&nama=$nama'</script>";
?>