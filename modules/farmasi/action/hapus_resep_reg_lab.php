...
if($result){
print "<script>alert('Data Berhasil di Hapus.');location.href='home.php?hal=content/resep_reg_lab&pasien_id=$pasien_id&pasien_id=$pasien_id&id=$pasien_id&no_resep=$no_resep&param_no=$param_no'</script>";
}
