...
if($r1>0)
{
 ...
 print"<script>location.href='home.php?hal=content/lihat_pencarian_resep&no_trans=$no_trans&param_no=$param_no&no_resep=$no_resep'</script>";
 }else
 {
print"<script>alert('Resep Tidak Ditemukan');location.href='home.php?hal=content/kasir_tes&no_trans=$no_trans&param_no=$param_no'</script>";
}
