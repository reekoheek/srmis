...
?>
<script>PopupCenter('content/cetak_struk_penjualan.php?no_transaksi=<? echo $no_trans; ?>','myPop1',800,800);</script>
<script>location.href='home.php?hal=content/kasir_tes'</script>
</body >
</html>