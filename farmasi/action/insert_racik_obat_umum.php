...
/* echo $param_no;
echo $no_racik; */
print "<script>location.href='home.php?hal=content/racik_obat_umum&no_racik=$no_racik&jenis_ket=$jenis_ket&no_ket=$no_ket&param_no=$param_no&no_resep=$no_resep&nama_pas=$nama_pas&rs_asal=$rs_asal&sub_margin=$sub_margin'</script>"; 
?>