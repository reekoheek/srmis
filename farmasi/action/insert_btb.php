...
if ($r['No_BTB'])
{
print "<script>alert('Data dengan No SPP $no_SPP telah di CLOSE.');location.href='home.php?hal=content/list_BTB'</script>";
}
else
{
$qbtb=mysql_query("Update permintaan_unit set No_BTB='$No_BTB', param_btb='$param_btb', tgl_received='$date' where No_SPP = '$no_SPP'");
print "<script>location.href='home.php?hal=content/lihat_status_spp&No_BTB=$No_BTB&No_SPP=$No_SPP&Tgl=$date&UsrBuat=".$_SESSION['U_USER']."'</script>";
}
?>