...
print "<script>location.href='home.php?hal=content/racik_obat_oca&no_resep=$no_resep&pasien_id=$pasien_id&no_racik=$no_racik&param_no=$param_no&nama=$nama&sub_margin=$sub_margin'</script>";
?>