<?php
	...
	//echo $countall;
		if ($countud == $countall)
		{
			...
			print "<script>alert('Barang dengan No SPP $No_SPP2 Telah diterima.');location.href='home.php?hal=content/list_BTB_igd'</script>";
		}
		...
		if ($rapp)
			{
		print "<script>alert('Masih Ada Item yang belum di Received...Harap Received');location.href='home.php?hal=content/lihat_status_spp_igd&No_SPP=$No_SPP2'</script>";
	    	}
		else 
			{
						$tgl=date("d/m/Y");
