...
print "<script>location.href='home.php?hal=content/racik_obat&no_resep=$no_resep&pasien_id=$pasien_id&no_racik=$no_racik&cara_bayar=$cara_bayar&namapas=$namapas&sub_margin=$sub_margin'</script>";
?>