...
?>
<script>PopupCenter('content/cetak_resep_umum.php?no_resep=<? echo $no_resep; ?>&nama=<? echo $nama; ?>&jenis_ket=<? echo $jenis_ket; ?>','myPop1',800,800);</script>
<script>location.href='home.php?hal=content/resep_reg_umum'</script>
</body >
</html>