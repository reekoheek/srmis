<?php
	...
	if ($_POST['nama'] == "")
	{
		print "<script>alert('Nama Obat Harus Di Isi Terlebih Dahulu.');location.href='home.php?hal=content/input_obat_igd&id=$pasien_id&pasien_id=$pasien_id&param_no=$param_no&no_resep=$no_resep&nama=$nama_pas'</script>";
	}
	else if ($_POST['ket'] == "")
	{
		print "<script>alert('Keterangan Harus Di Isi Terlebih Dahulu.');location.href='home.php?hal=content/input_obat_igd&id=$pasien_id&pasien_id=$pasien_id&param_no=$param_no&no_resep=$no_resep&nama=$nama_pas'</script>";
	}
	...
	{
		print "<script>alert('MAAF,..!! Jumlah Obat yang diminta lebih besar dari Stok Obat.');location.href='home.php?hal=content/input_obat_igd&pasien_id=$pasien_id&param_no=$param_no&no_resep=$no_resep&nama=$nama_pas'</script>";
	}
	else
	{
	//ini baru rumus
...
print "<script>alert('Data Telah Di Simpan dengan Jumlah Obat yang diberikan sebanyak $_POST[jumlah] .');location.href='home.php?hal=content/resep_reg_igd&pasien_id=$pasien_id&param_no=$param_no&no_resep=$no_resep&nama=$nama_pas'</script>"; 
	}
?>