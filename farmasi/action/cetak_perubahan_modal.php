...
(pageURL, title, 'toolbar=no, alwaysraised='+1+', fullScreen=no, locationbar=no, location=0, directories=no, status=no, menubar=0, scrollbars=yes, resizable=0, copyhistory=0, width=700, height=700, top=100, left=400');
...
<script>PopupCenter('content/lap_perubahan_modal.php?bln=<? echo $bln; ?>&thn=<? echo $thn; ?>','myPop1',800,800);</script>
<script>location.href='home.php?hal=content/neraca_lajur&thn=<?=$thn?>&bln=<?=$bln?>'</script>
