				...
				<tr>
					...
					<table border="0" cellpadding="2" cellspacing="2" width="100%">
						<tr>
							...
							if($crsp=="RPU")
							 {
							  echo"<td align=center><a href='../action/insert_resep_cari_to_kasir2.php?no_resep=$r1[no_resep]&no_trans=$no_trans&param_no=$param_no&pasien_id=$r1[pasien_id]&namapas=$r1[fld02]'>Bayar</a></td>";
							 }else
							 {
							 	echo"<td align=center><a href='../action/insert_resep_cari_to_kasir2.php?no_resep=$r1[no_resep]&no_trans=$no_trans&param_no=$param_no&pasien_id=$r1[pasien_id]&namapas=$r2[nama]'>Bayar</a></td>";	
							 }	
							  }else
							  {
