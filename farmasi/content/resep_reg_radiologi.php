...
$qp= mysql_query("SELECT * FROM resep_head WHERE LAST_INSERT_ID(param_no) and no_resep like 'RAD%' ORDER BY id DESC LIMIT 1");
				...
				<tr>
					...
					<table border="0" cellpadding="2" cellspacing="2" width="100%">
						<tr>
						  ...
						  <td width="314"><input type="text" name="no_resep" value="<?=$no_resep?>" readonly="true" size="17" style="background-color:#CCCFFF; "></td>
							<td width="99"></td>
						</tr>
						<tr>
							...
							{ 
							?> 
							<form method="post" action="home.php?hal=action/insert_resep_radiologi&no_resep=<?=$no_resep?>&param_no=<?=$param_no?>">
					  ...
					  <tr>
						...
						?>
						<td align="right">
						<form method="post" action="home.php?hal=action/insert_pencetakan_radiologi" enctype="multipart/form-data">
						...
						<td align="left">
						<form method="post" enctype="multipart/form-data" action="home.php?hal=action/insert_racik_obat_radiologi">
					  ...
					  <form method="post" action="home.php?hal=action/simpan_resep_radiologi" enctype="multipart/form-data">
					  Nama Obat : 
								...
								<?php
									...
									while ($r = mysql_fetch_array($q))
									{
										...
										echo "</td>
											...
											if ($r['racikan']=='YA')
											{
											echo"<a href=\"home.php?hal=content/racik_obat_radiologi&fld02=$r[fld02]&no_racik=$r[fld02]&id=$r[id]&pasien_id=$id_p&kd_barang=$r[kode_obat]&diberi=$r[diberi]&no_resep=$no_resep&param_no=$param_no&pasien_id=$id_p&nama=$_GET[nama]&sub_margin=$_GET[sub_margin]\">
											<font size=-1>EDIT</font></a> | <a href=\"home.php?hal=action/hapus_resep_reg_radiologi&id=$r[id]&pasien_id=$id_p&kd_barang=$r[kode_obat]&diberi=$r[diberi]&no_resep=$no_resep&param_no=$param_no&pasien_id=$id_p&nama=$_GET[nama]&sub_margin=$_GET[sub_margin]\" 
											onClick=\"return confirm('Apakah Anda benar-benar akan menghapus $r[fld01]?')\">
											<font size=-1>HAPUS</font></a>";
											}
											else
											{
											echo"<a href=\"home.php?hal=action/hapus_resep_reg_radiologi&id=$r[id]&pasien_id=$id_p&kd_barang=$r[kode_obat]&diberi=$r[diberi]&no_resep=$no_resep&param_no=$param_no&pasien_id=$id_p&nama=$_GET[nama]&sub_margin=$_GET[sub_margin]\" 
