...
#
$tgl = date("d/m/Y");
$query = "SELECT ms_barang.kd_barang, ms_barang.nama, quantity.min_qty, quantity.max_qty FROM ms_barang,quantity WHERE quantity.barang_id = ms_barang.kd_barang ORDER BY quantity.barang_id ASC";
#
