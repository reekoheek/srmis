...
$query = "SELECT no_trans,no_resep,fld01,total FROM penjualan_head where created_datetime between '$ta1' and '$ta2' order by id ASC "; 
$sql = mysql_query ($query); 
$subt=mysql_query("select sum(total) as subtotal from penjualan_head where created_datetime between '$ta1' and '$ta2' order by id ASC ");
$nama_shift=$rshift['nama'];
/* }else 
if($shift==2)
{
 	$ta1=$t1." 14:00:01";
...
$judul = "LAPORAN TRANSAKSI KASIR ".$nama_shift; 
$header = array( 
