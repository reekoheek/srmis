...
$query = "SELECT no_trans,tgl,motor,mobil,total FROM parkir where tgl between '$t1' and '$t2' order by id ASC "; 
$sql = mysql_query ($query); 
$subt=mysql_query("select sum(total) as subtotal from parkir where tgl between '$t1' and '$t2'");
...
$judul = "LAPORAN TRANSAKSI PARKIR"; 
$header = array( 
  array("label"=>"NO TRANSAKSI", "length"=>40, "align"=>"C"), 
  array("label"=>"TANGGAL", "length"=>40, "align"=>"C"), 
  array("label"=>"JML MOBIL", "length"=>30, "align"=>"C"), 
  array("label"=>"JML MOTOR", "length"=>30, "align"=>"C"), 
