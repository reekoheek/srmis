				...
				<tr>
					...
					<tr valign="top">
							<td align="Left" height="27px">
								<div id="container">
								<form method="post" action="home.php?hal=content/daftar_barang_igd" enctype="multipart/form-data">
					          ...
					          <!--
								...
								--></td>
							<td align="right"><?php
									echo '<form method=post action=home.php?hal=action/insert_spp_igd enctype=multipart/form-data>';
						...
						<tr>
							<td>
								<?php
									...
									if ($cari)
									{
									$query  = mysql_query ("SELECT * FROM barang_unit,ms_barang WHERE ms_barang.kd_barang LIKE '$cari%' AND barang_unit.barang_id=ms_barang.id AND barang_unit.stok <= barang_unit.min_stok AND barang_unit.unit_id='51' ORDER BY ms_barang.ex_year,ms_barang.ex_month,ms_barang.ex_date ASC");
									}
									else
									{
									$query  = mysql_query ("SELECT * FROM barang_unit,ms_barang WHERE barang_unit.barang_id=ms_barang.id  AND barang_unit.stok <= barang_unit.min_stok AND barang_unit.unit_id='51' ORDER BY ms_barang.ex_year,ms_barang.ex_month,ms_barang.ex_date ASC
									...
									while ($result = mysql_fetch_array($query))
									{
										...
										echo "<td width=70px>$result[kd_barang]</td>
											...
											else if (($pmonth > $result['ex_month']) AND ($pyear > $result['ex_year']) AND ($pdate > $result['ex_date'])) 
											{
											...
											echo "<td align=center width=140px><a href=home.php?hal=content/input_daftar_barang&barang_id=$result[barang_id]>
											...
											<a href=home.php?hal=content/detail_barang&barang_id=$result[barang_id]><font style=font-size:12px;>DETAIL</font></a>
											</td>
											</tr>";
										$no++;
									}
									...
									{
   										$page = $pageNum - 1;
   								   	 	$prev = " <a href=\"$self?page=$page&hal=content/daftar_barang_igd\"><font color='#565957' size=-1>[&laquo;]</font></a> ";

    									$first = " <a href=\"$self?page=1&hal=content/daftar_barang_igd\"><font color='#565957' size=-1>[&laquo;&laquo;]</font></a> ";
									}
									else
									{
   			 							$prev  = ' [&laquo;] ';
									...
									{
    									$page = $pageNum + 1;
    									$next = " <a href=\"$self?page=$page&hal=content/daftar_barang_igd\"><font color='#565957' size=-1>[&raquo;]</font></a> ";

    									$last = " <a href=\"$self?page=$maxPage&hal=content/daftar_barang_igd\"><font color='#565957' size=-1>[&raquo;&raquo;]</font></a> ";
									}
									else
									{
   										$next = ' [&raquo;] ';
								...
								<?php
									...
									while ($result2 = mysql_fetch_array($query2))
									{
										...
										echo "<td width=70px>$result2[kd_barang]</td>
											...
											{
												$qy2 = mysql_query("UPDATE barang_unit SET flags='0' WHERE barang_id='$result2[barang_id]'"); 
											...
											echo "<td align=center width=140px><a href=home.php?hal=content/input_daftar_barang&barang_id=$result2[barang_id]>
											<font style=font-size:12px;>EDIT</font></a> | 
											<a href=\"home.php?hal=action/hapus_barang&barang_id=$result2[barang_id]\" 
											onClick=\"return confirm('Apakah Anda benar-benar akan menghapus $result[nama] ?')\">
											<font style=font-size:12px;>HAPUS</font></a> | 
											<a href=home.php?hal=content/detail_barang&barang_id=$result2[barang_id]><font style=font-size:12px;>DETAIL</font></a>
											</td>
											</tr>";
										$no2++;
									}
									...
									{
   										$page2 = $pageNum2 - 1;
   								   	 	$prev2 = " <a href=\"$self2?page=$page2&hal=content/daftar_barang_igd\"><font color='#565957' size=-1>[&laquo;]</font></a> ";

    									$first2 = " <a href=\"$self2?page=1&hal=content/daftar_barang_igd\"><font color='#565957' size=-1>[&laquo;&laquo;]</font></a> ";
									}
									else
									{
   			 							$prev2  = ' [&laquo;] ';
									...
									{
    									$page2 = $pageNum2 + 1;
    									$next2 = " <a href=\"$self2?page=$page2&hal=content/daftar_barang_igd\"><font color='#565957' size=-1>[&raquo;]</font></a> ";

    									$last2 = " <a href=\"$self2?page=$maxPage2&hal=content/daftar_barang_igd\"><font color='#565957' size=-1>[&raquo;&raquo;]</font></a> ";
									}
									else
									{
   										$next2 = ' [&raquo;] ';
