		...
		<td id="tengah_isi" >
			...
			<table border="0" cellpadding="0" cellspacing="0" width="70%">
				<tr>
					...
					<form method="post" enctype="multipart/form-data" action="home.php?hal=action/insert_permintaan_obat_igd">
					...
					<table border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td>
							<form method="post" enctype="multipart/form-data" action="home.php?hal=content/daftar_permintaan_obat_igd">
