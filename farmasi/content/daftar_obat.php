				...
				<tr>
					...
					<table border="0" cellpadding="2" cellspacing="2" width="100%">
						<tr>
							<td align="right">
								<div id="container">
								<form method="post" action="home.php?hal=content/daftar_obat" enctype="multipart/form-data">
								...
								<?php
									...
									while ($result = mysql_fetch_array($query))
									{
										...
										echo "<td width=70px>$result[kd_barang]</td>
											...
											<form method=post action='home.php?hal=content/input_obat' enctype=multipart/form-data>
