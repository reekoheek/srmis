			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<table border="0" cellpadding="2" cellspacing="2" width="100%">
						<tr>
							<td>Kode Transaksi </td><td>:&nbsp;<input type="text" readonly="true" value="<?=$transaksi?>" name="transaksi"></td>
							<td></td>
							<td></td>
							<td></td>
						</tr>
						<tr>
							<td>No Rekam Medik </td><td>:&nbsp;<input type="text" readonly="true" value="<?=$r['no_rm']?>" name="no_rm"></td>
							<td></td>
							...
							<form method="post" enctype="multipart/form-data" action="home.php?hal=content/add">
								...
								<input type="hidden" readonly="true" value="<?=$r['no_rm']?>" name="no_rm">
								<input type="Submit" value="Tambah Barang">
							</form>
							</td>
							<td align="right" width="55">
							<form method="post" action="content/cetak_penjualan.php">
							<input type="hidden" readonly="true" value="<?=$transaksi?>" name="transaksi">
							<input type="hidden" readonly="true" value="<?=$r['no_rm']?>" name="no_rm">
							...
							<form method="post" action="home.php?hal=content/transaksi_penjualan">	
								...
								<?php
									...
									while ($result = mysql_fetch_array($query))
									{
										...
										echo "</td>
												...
												<input type=hidden name=jumlah value=$result[4]>
