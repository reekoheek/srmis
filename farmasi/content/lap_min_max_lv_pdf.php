...
#
$tgl = date ("d/m/Y");
$query = "SELECT ms_barang.kd_barang,ms_barang.nama, stok_level.min_stock_lv, stok_level.max_stock_lv FROM ms_barang,stok_level WHERE stok_level.barang_id = ms_barang.kd_barang ORDER BY stok_level.barang_id ASC";
#
