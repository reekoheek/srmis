			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<table border="0" cellpadding="2" cellspacing="2" width="100%">
						<tr>
							<form method="post" action="home.php?hal=content/list_retur" enctype="multipart/form-data">
							<td align="right">
						  <!--
						  ...
						  <div id="container"> Cari No. RPB:
							...
							<?php
									echo '<form method=post action=home.php?hal=action/insert_rpb enctype=multipart/form-data>';
									$query  = mysql_query ("SELECT * FROM permintaan_unit,permintaan_unitdetail WHERE permintaan_unit.No_SPP = permintaan_unitdetail.No_SPP and permintaan_unit.Unit='".$_SESSION['U_SUBUNIT']."' and permintaan_unitdetail.status_detail ='6' ORDER BY permintaan_unit.No_SPP DESC");
									$result = mysql_fetch_array($query);
									echo "<input type=submit value='Buat Retur'>";
									echo "<input name='No_SPP' type='hidden' value='$result[No_SPP]'>";
									echo '</form>';
							?>							</td>
						</tr>
					</table>
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tr>
							...
							if ($cari)
									{
										$query2  = mysql_query ("SELECT * FROM permintaan_unitdetail,permintaan_unit where permintaan_unitdetail.No_SPP = permintaan_unit.No_SPP and permintaan_unit.No_SPP like '$cari%' AND permintaan_unit.Unit='".$_SESSION['U_SUBUNIT']."'ORDER BY No_SPP DESC");
									}
									else
									{
										$query2  = mysql_query ("SELECT * FROM permintaan_unitdetail WHERE Unit='".$_SESSION['U_SUBUNIT']."' ORDER BY No_SPP DESC");
									}
							$query2  = mysql_query ("SELECT * FROM permintaan_unit,permintaan_unitdetail WHERE permintaan_unit.No_SPP = permintaan_unitdetail.No_SPP and permintaan_unit.Unit='".$_SESSION['U_SUBUNIT']."' and permintaan_unitdetail.status_detail ='6' ORDER BY permintaan_unit.No_SPP DESC");
																		
							echo '<table border=0 cellpadding=2 cellspacing=2 width=100%>
									<tr bgcolor=#414141 align=center>
										<td><font color=#FFFFFF>Tanggal Retur</font></td>
										<td ><font color=#FFFFFF>No. SPP</font></td>
										<td><font color=#FFFFFF>No. RPB</font></td>
										<td ><font color=#FFFFFF>Kode Barang</font></td>
									...
									while ($result2 = mysql_fetch_array($query2))
									{
										...
										echo "<td align=center width=80px>$result2[tgl_retur]</td>
											...
											echo "<td align=center width=110px>".$result2['No_RPB']."</td>";
											echo "<td align=center width=110px>".$result2['barang_id']."</td>";
											echo "<td align=center width=110px>".$result2['Nm_Barang']."</td>";
