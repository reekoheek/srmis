					...
					<table border="0" cellpadding="2" cellspacing="2" width="100%">
						<tr>
							...
							<tr align="right">
								...
								<tr align="center">
									<td>DAFTAR RESEP UMUM PER <?=$tgl?></td>
								</tr>
								<tr align="center">
							...
							while($r1=mysql_fetch_array($q1))
							{
							 ...
							 <td align=center><a href='home.php?hal=action/to_preview_resep&no_resep=$r1[no_resep]&no_trans=$no_trans&param_no=$param_no'>$r1[no_resep]</a></td>
							 		<td align=left>$r1[fld02]</td>
									<td align=left>$r1[fld03]</td>
									<td align=center><a href='home.php?hal=action/insert_resep_to_kasir&no_resep=$r1[no_resep]&no_trans=$no_trans&param_no=$param_no&namapas=$r1[fld02]&rsasal=$r1[fld03]'>Bayar</a></td>
									</tr>";
									$no++;
							}
							echo"</table>
							...
							echo '<div align=center><br>';
									...
									{
   										$page = $pageNum - 1;
   								   	 	$prev = " <a href=\"$self?page=$page&hal=content/lihat_resep_umum&no_trans=$no_trans&param_no=$param_no\"><font color='#565957' size=-1>[&laquo;]</font></a> ";

    									$first = " <a href=\"$self?page=1&hal=content/lihat_resep_umum&no_trans=$no_trans&param_no=$param_no\"><font color='#565957' size=-1>[&laquo;&laquo;]</font></a> ";
									}
									else
									{
   			 							$prev  = ' [&laquo;] ';
									...
									{
    									$page = $pageNum + 1;
    									$next = " <a href=\"$self?page=$page&hal=content/lihat_resep_umum&no_trans=$no_trans&param_no=$param_no\"><font color='#565957' size=-1>[&raquo;]</font></a> ";

    									$last = " <a href=\"$self?page=$maxPage&hal=content/lihat_resep_umum&no_trans=$no_trans&param_no=$param_no\"><font color='#565957' size=-1>[&raquo;&raquo;]</font></a> ";
									}
									else
									{
   										$next = ' [&raquo;] ';
