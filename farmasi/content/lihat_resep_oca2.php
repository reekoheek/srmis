...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		...
		<table border="0" width="100%" cellpadding="0" cellspacing="0">
			<tr>
				<td width="169px">&nbsp;</td>
				<td width="300px" bgcolor="#9b9999">&nbsp;&nbsp;<b><font color="#fefafa"> DAFTAR RESEP OKA </font></b></td>
				<td></td>
			</tr>
		</table>
		</td>
	...
	$rq=mysql_fetch_array($qq);
							 ...
							 <td align=center><a href='../action/to_preview_resep_oca2.php?no_resep=$r1[no_resep]&no_trans=$no_trans&param_no=$param_no'>$r1[no_resep]</a></td>";
