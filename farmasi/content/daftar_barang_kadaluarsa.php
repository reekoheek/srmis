...
<script>
	function lookup(inputString) {
		if(inputString.length == 0) {
			...
			$.post("action/string_daftar_barang_kadaluarsa.php", {mysearchString: ""+inputString+""}, function(data){
				if(data.length >0) {
					$('#suggestions').show();
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		...
		<table border="0" width="100%" cellpadding="0" cellspacing="0">
			<tr>
				<td width="8px">&nbsp;</td>
				<td width="300px" bgcolor="#9b9999">&nbsp;&nbsp;<font style="font-size:14px; " color="#fefafa"><b>Daftar Barang Kadaluarsa</b></font></td>
				<td></td>
			</tr>
		</table>
		</td>
						...
						<tr valign="top">
							<td align="Left">
					          ...
					          <!--
								...
								--></td>
							<td align="right">
							<form method="post" enctype="multipart/form-data" action="content/lap_ms_barang_kadaluarsa_pdf.php">
								<input type="submit" value="Laporan PDF">
							</form>
							</td>
							<td align="right" width="100px">
							<form method="post" enctype="multipart/form-data" action="content/lap_ms_barang_kadaluarsa.php">
						...
						<tr>
							<td>
								<?php
									...
									{
   										$page = $pageNum - 1;
   								   	 	$prev = " <a href=\"$self?page=$page&hal=content/daftar_barang_kadaluarsa\"><font color='#565957' size=-1>[&laquo;]</font></a> ";

    									$first = " <a href=\"$self?page=1&hal=content/daftar_barang_kadaluarsa\"><font color='#565957' size=-1>[&laquo;&laquo;]</font></a> ";
									}
									else
									{
   			 							$prev  = ' [&laquo;] ';
									...
									{
    									$page = $pageNum + 1;
    									$next = " <a href=\"$self?page=$page&hal=content/daftar_barang_kadaluarsa\"><font color='#565957' size=-1>[&raquo;]</font></a> ";

    									$last = " <a href=\"$self?page=$maxPage&hal=content/daftar_barang_kadaluarsa\"><font color='#565957' size=-1>[&raquo;&raquo;]</font></a> ";
									}
									else
									{
   										$next = ' [&raquo;] ';
