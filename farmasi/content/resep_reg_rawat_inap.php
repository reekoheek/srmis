...
$qp= mysql_query("SELECT * FROM resep_head WHERE LAST_INSERT_ID(param_no) and no_resep like 'RRI%' ORDER BY id DESC LIMIT 1");
...
else
{
	...
	if ($_GET['sub_margin'])
	{
		$qmar2=mysql_query("select * from sub_margin2 where margin_id='$_GET[sub_margin]'");
				...
				<tr>
					...
					<table border="0" cellpadding="2" cellspacing="2" width="100%">
						<tr>
						  ...
						  <td width="316"><input type="text" name="no_resep" value="<?=$no_resep?>" readonly="true" size="17" style="background-color:#CCCFFF; "></td>
							<td width="97"></td>
						</tr>
						<tr>
							...
							{ 
							?> 
							<form method="post" action="home.php?hal=action/insert_resep_rawat_inap&no_resep=<?=$no_resep?>&param_no=<?=$param_no?>">
								<input type="text" name="no_rm"  size="18" value="" tabindex="1"> 
					  ...
					  <tr>
						...
						?>
						<td align="right">
						<form method="post" action="home.php?hal=action/insert_pencetakan_rawat_inap" enctype="multipart/form-data">
						...
						<td align="left">
						<form method="post" enctype="multipart/form-data" action="home.php?hal=action/insert_racik_obat_rawat_inap">
					  ...
					  <form method="post" action="home.php?hal=action/simpan_resep_rawat_inap" enctype="multipart/form-data">
					  Nama Obat : 
					  ...
					  Dosis : <select name="dosis_id">
							...
							if(!$_GET['sub_margin'])
								...
								echo"
										...
										$qsubmar=mysql_query("select * from sub_margin2 WHERE id='$rmar[id]'");
								...
								{	
									$qsubmargin=mysql_query("select * from sub_margin2 where margin_id='$_GET[sub_margin]'");
								...
								<?php
									...
									while ($r = mysql_fetch_array($q))
									{
										...
										echo "</td>
											...
											if ($r['racikan']=='YA')
											{
											echo"<a href=\"home.php?hal=content/racik_obat_rawat_inap&fld02=$r[fld02]&no_racik=$r[fld02]&id=$r[id]&pasien_id=$id_p&kd_barang=$r[kode_obat]&diberi=$r[diberi]&no_resep=$no_resep&param_no=$param_no&pasien_id=$id_p&nama=$_GET[nama]&sub_margin=$_GET[sub_margin]\">
											<font size=-1>EDIT</font></a> | <a href=\"home.php?hal=action/hapus_resep_reg_rawat_inap&id=$r[id]&pasien_id=$id_p&kd_barang=$r[kode_obat]&diberi=$r[diberi]&no_resep=$no_resep&param_no=$param_no&pasien_id=$id_p&nama=$_GET[nama]&sub_margin=$_GET[sub_margin]\" 
											onClick=\"return confirm('Apakah Anda benar-benar akan menghapus $r[fld01]?')\">
											<font size=-1>HAPUS</font></a>";
											}
											else
											{
											echo"<a href=\"home.php?hal=action/hapus_resep_reg_rawat_inap&id=$r[id]&pasien_id=$id_p&kd_barang=$r[kode_obat]&diberi=$r[diberi]&no_resep=$no_resep&param_no=$param_no&pasien_id=$id_p&nama=$_GET[nama]&sub_margin[sub_margin]\" 
