...
.style10 {font-size: 9; font-weight: bold; }
</style>
</head>
...
<table width="500" border="0">
  <tr>
    <td height="54" colspan="3" style="border-bottom-style:solid"><div align="center" class="style5" style="font:Verdana, Arial, Helvetica, sans-serif;font-style:oblique;">
	    
		<br>INSTALASI FARMASI</br>
		<br><strong>RS. BHINEKA BAKTI HUSADA</strong></br>
		<br>Jl. Cabe Raya No.17 Telp. 7490018 - 7490829 FAX. 7499157</br>
        <br>PONDOK CABE - TANGERANG<br />
		<br>Apoteker : Bambang Tri Sasongko, Ssi. Apt.</br>
              <br>
          SIK : KP 01.01.1.3.13059</br>
	  </div></td>
  </tr>
  <font size="10">
  <tr>
    ...
    <td width="177"><font size="1"><? echo $tanggal; ?></font></td>
	<td width="42"><input class="noPrint" type="button" value="Print" onclick="window.print()"></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><font size="1">:</font></td>
    <td><font size="1"><? echo $namadok; ?></font></td>
	<td>&nbsp;</td>
  </tr>
