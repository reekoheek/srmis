					...
					<table border="0" cellpadding="2" cellspacing="2" width="100%">
						<tr>
							...
							while($r1=mysql_fetch_array($q1))
							{
							 ...
							 <td align=center><a href='../action/to_preview_resep_igd2.php?no_resep=$r1[no_resep]&no_trans=$no_trans&param_no=$param_no'>$r1[no_resep]</a></td>";
