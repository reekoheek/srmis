...
$query = "SELECT * FROM ms_barang,quantity WHERE  ms_barang.kd_barang=quantity.barang_id ORDER BY quantity.barang_id ASC";
...
/*	$q_spb = mysql_query("SELECT * FROM detail_spb WHERE LAST_INSERT_ID(barang_id) AND barang_id = '$data[0]' ORDER BY barang_id DESC LIMIT 1");
