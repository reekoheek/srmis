...
$rar=mysql_fetch_array($qar);
		...
		if ($r)
		{
			print "<script>location.href='home.php?hal=content/list_BTB_igd'</script>";
		}
							...
							<td>
								...
								<table width="100%">
									...
									<td align="right" valign="top">
										...
										{
										?>
											<form method="post" enctype="multipart/form-data" action="home.php?hal=action/terima_barang_unit_igd">
