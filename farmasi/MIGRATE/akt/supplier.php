...
<title>Akuntansi Rumah Sakit - Supplier Obat Dan BHP</title>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="60" class="header">Akuntansi - SUPPLIER BHP DAN OBAT</td>
  </tr>
  <tr>
  ...
  <tr>
    <td valign="top" class="content"><div id="keterangan">Sistim Akuntasi. Data Supplier Obat dan BHP Rumah Sakit. Kode Awal adalah SP</div>
              <br/>
      <div id="CollapsiblePanel1" class="CollapsiblePanel">
        <div class="CollapsiblePanelTab" tabindex="0">TABEL DATA SUPPLIER</div>
        <div class="CollapsiblePanelContent">
          <table width="1000" border="0" cellpadding="3" cellspacing="1" class="tableisi">
            <tr>
              ...
              <td colspan="6" align="center" class="t_head">&nbsp;</td>
            </tr>
            <tr>
              <td width="80" align="center" class="t_head">Kode Supp</td>
              <td width="165" align="left" class="t_head">Nama Supplier</td>
              <td align="left" class="t_head">Alamat</td>
              <td width="120" align="left" class="t_head">Kota</td>
              <td width="120" align="left" class="t_head">No Telp - Fax</td>
              <td width="120" align="left" class="t_head">Nama Kontak</td>
              ...
              <form id="form2" name="form2" method="post" action="">
                <td align="center"><input name="id_hapus" type="hidden" id="id_hapus" value="SP0001" />
              ...
              <td align="left">-</td>
              <td align="left">-&nbsp;-&nbsp;-</td>
              <td align="left">Joko Sasongko</td>
              <form id="form1" name="form1" method="post" action="">
              ...
              <form id="form2" name="form2" method="post" action="">
                <td align="center"><input name="id_hapus" type="hidden" id="id_hapus" value="SP0002" />
                    <input name="imageField2" type="image" id="imageField2" src="../images/hapus.gif" align="middle" />
                </td>
              </form>
            </tr>
