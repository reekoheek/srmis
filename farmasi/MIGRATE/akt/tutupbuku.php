...
<title>Akuntansi Rumah Sakit - Tutup Buku Tahunan Akuntansi</title>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="60" class="header">Akuntansi - Tutup Buku Tahunan</td>
  </tr>
  <tr>
  ...
  <tr>
    <td valign="top" class="content"><div id="keterangan">Sistim Akuntasi Rumah Sakit. Proses Tutup Buku Tahunan.</div> 
      <div id="warning">&lt;!&gt; Proses ini tidak dapat dibalikkan lagi. Pastikan Neraca anda sudah balance di akhir tahun yang akan ditutup !</div>
      <div class="fields">
    <fieldset>
    <legend>PENUTUPAN PEMBUKUAN</legend>
    
    <form id="form3" name="form3" method="post" action="">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF" class="tableisi">
        <tr>
          <td width="40%" class="row_alt2">Tahun Ditutup</td>
          <td align="center"><input name="textfield" type="text" id="textfield" value="2010" /></td>
        </tr>
        <tr>
          <td class="row_alt2">Tahun Dibuka</td>
          <td align="left">2011          </td>
        </tr>
        <tr>
          <td class="row_alt2"><input name="newId" type="hidden" id="newId" value="44732" /></td>
