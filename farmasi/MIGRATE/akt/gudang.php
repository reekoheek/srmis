...
<title>Akuntansi Rumah Sakit - Gudang Obat Dan BHP</title>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="60" class="header">Akuntansi - Gudang Obat dan BHP</td>
  </tr>
  <tr>
  ...
  <tr>
    <td valign="top" class="content"><div id="keterangan">Sistim Akuntasi Rumah Sakit. Selamat Datang.</div>
        <br/>    <div id="CollapsiblePanel1" class="CollapsiblePanel">
      <div class="CollapsiblePanelTab" tabindex="0">DAFTAR GUDANG</div>
      <div class="CollapsiblePanelContent">
        <table width="500" border="0" align="left" cellpadding="3" cellspacing="1" class="tableisi">
          <tr>
            <td colspan="2" align="left"><a href="?var=baru">Isi Baru&nbsp;<img class="icon" src="../images/add_icon.gif" alt="New" width="16" height="16" align="absmiddle" /></a></td>
            <td width="65" align="center">&nbsp;</td>
            <td width="65" align="center">&nbsp;</td>
          </tr>
          <tr>
            <td width="40" align="center" class="t_head">No</td>
            <td width="150" align="left" class="t_head">Daftar Gudang</td>
            <td width="65" align="center" class="t_head">Edit</td>
            <td width="65" align="center" class="t_head">Hapus</td>
          </tr>
            ...
            <form id="form2" name="form1" method="post" action="">
              <td align="center"><input name="id_edit" type="hidden" id="id_edit" value="INSTALASI FARMASI" />
                  <input name="imageField" type="image" id="imageField" src="../images/edit_icon.gif" align="middle" />
              </td>
            </form>
            <form id="form4" name="form2" method="post" action="">
              <td align="center"><input name="id_hapus" type="hidden" id="id_hapus" value="INSTALASI FARMASI" />
                  <input name="imageField2" type="image" id="imageField2" src="../images/hapus.gif" align="middle" />
              </td>
            </form>
          </tr>
                    <tr class="row_alt2" onmousemove="this.className='row_hover'" onmouseout="this.className='row_alt2'">
            <td align="center">2</td>
            <td align="left">BEDAH</td>
            <form id="form2" name="form1" method="post" action="">
              <td align="center"><input name="id_edit" type="hidden" id="id_edit" value="BEDAH" />
                  <input name="imageField" type="image" id="imageField" src="../images/edit_icon.gif" align="middle" />
              </td>
            </form>
            <form id="form4" name="form2" method="post" action="">
              <td align="center"><input name="id_hapus" type="hidden" id="id_hapus" value="BEDAH" />
                  <input name="imageField2" type="image" id="imageField2" src="../images/hapus.gif" align="middle" />
              </td>
            </form>
          </tr>
            ...
            <form id="form2" name="form1" method="post" action="">
              <td align="center"><input name="id_edit" type="hidden" id="id_edit" value="RADIOLOGI" />
                  <input name="imageField" type="image" id="imageField" src="../images/edit_icon.gif" align="middle" />
              </td>
            </form>
            <form id="form4" name="form2" method="post" action="">
              <td align="center"><input name="id_hapus" type="hidden" id="id_hapus" value="RADIOLOGI" />
                  <input name="imageField2" type="image" id="imageField2" src="../images/hapus.gif" align="middle" />
              </td>
            </form>
          </tr>
            ...
            <form id="form2" name="form1" method="post" action="">
              <td align="center"><input name="id_edit" type="hidden" id="id_edit" value="IGD" />
                  <input name="imageField" type="image" id="imageField" src="../images/edit_icon.gif" align="middle" />
              </td>
            </form>
            <form id="form4" name="form2" method="post" action="">
              <td align="center"><input name="id_hapus" type="hidden" id="id_hapus" value="IGD" />
                  <input name="imageField2" type="image" id="imageField2" src="../images/hapus.gif" align="middle" />
              </td>
            </form>
          </tr>
            ...
            <td align="left">GUDANG PATEN</td>
            <form id="form2" name="form1" method="post" action="">
              <td align="center"><input name="id_edit" type="hidden" id="id_edit" value="GUDANG PATEN" />
                  <input name="imageField" type="image" id="imageField" src="../images/edit_icon.gif" align="middle" />
              </td>
            </form>
            <form id="form4" name="form2" method="post" action="">
              <td align="center"><input name="id_hapus" type="hidden" id="id_hapus" value="GUDANG PATEN" />
                  <input name="imageField2" type="image" id="imageField2" src="../images/hapus.gif" align="middle" />
              </td>
            </form>
          </tr>
            ...
            <td align="left">GUDANG UMUM</td>
            <form id="form2" name="form1" method="post" action="">
              <td align="center"><input name="id_edit" type="hidden" id="id_edit" value="GUDANG UMUM" />
                  <input name="imageField" type="image" id="imageField" src="../images/edit_icon.gif" align="middle" />
              </td>
            </form>
            <form id="form4" name="form2" method="post" action="">
              <td align="center"><input name="id_hapus" type="hidden" id="id_hapus" value="GUDANG UMUM" />
                  <input name="imageField2" type="image" id="imageField2" src="../images/hapus.gif" align="middle" />
              </td>
            </form>
          </tr>
            ...
            <td align="left">GUDANG GENERIK</td>
            <form id="form2" name="form1" method="post" action="">
              <td align="center"><input name="id_edit" type="hidden" id="id_edit" value="GUDANG GENERIK" />
                  <input name="imageField" type="image" id="imageField" src="../images/edit_icon.gif" align="middle" />
              </td>
            </form>
            <form id="form4" name="form2" method="post" action="">
              <td align="center"><input name="id_hapus" type="hidden" id="id_hapus" value="GUDANG GENERIK" />
                  <input name="imageField2" type="image" id="imageField2" src="../images/hapus.gif" align="middle" />
              </td>
            </form>
          </tr>
            ...
            <td align="left">LABORAT</td>
            <form id="form2" name="form1" method="post" action="">
              <td align="center"><input name="id_edit" type="hidden" id="id_edit" value="LABORAT" />
                  <input name="imageField" type="image" id="imageField" src="../images/edit_icon.gif" align="middle" />
              </td>
            </form>
            <form id="form4" name="form2" method="post" action="">
              <td align="center"><input name="id_hapus" type="hidden" id="id_hapus" value="LABORAT" />
                  <input name="imageField2" type="image" id="imageField2" src="../images/hapus.gif" align="middle" />
              </td>
            </form>
          </tr>
            ...
            <td align="left">BERSALIN</td>
            <form id="form2" name="form1" method="post" action="">
              <td align="center"><input name="id_edit" type="hidden" id="id_edit" value="BERSALIN" />
                  <input name="imageField" type="image" id="imageField" src="../images/edit_icon.gif" align="middle" />
              </td>
            </form>
            <form id="form4" name="form2" method="post" action="">
              <td align="center"><input name="id_hapus" type="hidden" id="id_hapus" value="BERSALIN" />
                  <input name="imageField2" type="image" id="imageField2" src="../images/hapus.gif" align="middle" />
              </td>
            </form>
          </tr>
