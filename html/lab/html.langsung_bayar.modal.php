...
<input type="hidden" name="lb_id_kunjungan_lab" id="lb_id_kunjungan_lab" />
			...
			<legend>Pembayaran</legend>
				<table cellpadding="2" cellspacing="2" border="0" style="width:100%">
					...
					<tr>
                        ...
                        <input type="button" name="lb_simpan" id="lb_simpan" value="Cetak Kwitansi" class="inputan" onclick="xajax_simpan_langsung_bayar(xajax.getFormValues('form_lb'));" />&nbsp;&nbsp;
