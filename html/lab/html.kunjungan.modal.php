...
<div class="modal_title_bar">Input Specimen Laboratorium</div>
<form method="post" action="<?$_SERVER['PHP_SELF']?>" name="input_kunjungan" id="input_kunjungan" onsubmit="return false;">
<input type="hidden" name="input_id_kunjungan_lab" id="input_id_kunjungan_lab" />
	...
	<tr>
		...
		<td>
			...
			<legend>Specimen</legend>
				<input type="hidden" name="jml_specimen" id="jml_specimen" value="1" />
				<a href="javascript:void(0)" title="Add Karcis" onclick="xajax_cari_specimen('0',xajax.getFormValues('cari_specimen'));buka_specimen(this);" class="btn_add"><img src="<?=IMAGES_URL?>add.gif" alt="" border="0" />&nbsp;&nbsp;Tambah Specimen</a>
				<table cellpadding="0" cellspacing="0" border="0" class="tabel_biaya">
					...
					<tbody id="tbody_input_specimen"></tbody>
				</table>
			</fieldset>
			<!--<fieldset class="fieldset_modal">
...
<div id="form_cari_specimen" class="window_modal" style="display:none;left:30px;width:340px;z-index:4">
	<img src="<?=IMAGES_URL?>close.png" alt="Tutup" onclick="tutup_specimen();" class="close_button" />
	<h3>Daftar Specimen</h3>
	<form method="post" action="<?$_SERVER['PHP_SELF']?>" name="cari_specimen" id="cari_specimen" onsubmit="return false;">
	<input type="hidden" name="kelas" id="kelas" value="" />
	<table cellpadding="0" cellspacing="5" border="0" class="form">
		<tr>
			<td style="width:100px;">Specimen</td>
			<td>
				<input type="text" name="specimen" id="specimen" class="inputan" onkeypress="xcari_specimen(event)" onkeyup="hurufBesar(this)" size="30" />&nbsp;&nbsp;
				<input type="button" name="cari_specimen_cari" id="cari_specimen_cari" value="Cari" class="inputan" onclick="xajax_cari_specimen('0',xajax.getFormValues('cari_specimen'));" onkeypress="focusNext('specimen', event, 'specimen', this)" />
			</td>
		</tr>
	</table>
	</form>
	<div id="specimen_navi" class="navi"></div>
	<div id="list_specimen"></div>
</div>
