...
<table cellpadding="0" cellspacing="2" border="0" class="form" style="margin:5px">
	...
	<tr>
		<td><label for="dp_lab"><input type="checkbox" name="dp_lab" id="dp_lab" value="1" onkeypress="focusNext( 'dp_lab', event, 'dp_pengirim', this)" class="inputan" checked="true"/>Laboratorium</label></td>
	</tr>
	<tr>
