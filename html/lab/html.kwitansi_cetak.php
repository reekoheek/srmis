	...
	<tr>
		<td>
			<table cellpadding="0" cellspacing="5" border="0" class="form">
				...
				<tr>
					<td>No. RM</td>
					<td><?=$_SESSION[lab][langsung_bayar][data_px][id_display]?></td>
				</tr>
				<tr>
					<td style="vertical-align:top">Nama Pasien</td>
					<td><?=$_SESSION[lab][langsung_bayar][data_px][nama]?></td>
				</tr>
				<tr>
					<td>Jenis Kelamin</td>
					<td><?=$_SESSION[lab][langsung_bayar][data_px][jk]?></td>
				</tr>
				<tr>
					<td>Usia</td>
					<td><?=$_SESSION[lab][langsung_bayar][data_px][usia]?></td>
				</tr>
				<tr>
					<td style="vertical-align:top">Alamat</td>
					<td><?=$_SESSION[lab][langsung_bayar][data_px][alamat]?></td>
				</tr>
				<tr>
					<td>Tgl Periksa</td>
					<td><?=tanggalIndo($_SESSION[lab][langsung_bayar][data_px][tgl_periksa], "j F Y")?></td>
				</tr>
				<tr>
					<td style="vertical-align:top">Cara Bayar</td>
					<td><?=$_SESSION[lab][langsung_bayar][data_px][cara_bayar]?></td>
				</tr>
				<tr>
					<td>Nomor</td>
					<td><?=$_SESSION[lab][langsung_bayar][data_px][nomor]?></td>
				</tr>
			</table>
		</td>
	</tr>
