...
<form method="post" action="<?$_SERVER['PHP_SELF']?>" name="lap_rl2a1" id="lap_rl2a1" onsubmit="return false;">
<table cellpadding="0" cellspacing="2" border="0" class="form">
	...
	<tr>
		<td colspan="2" style="text-align: center;"><input type="button" name="cari" id="cari" value="Tampilkan" class="inputan" onclick="xajax_get_lap_rl2a1(xajax.getFormValues('lap_rl2a1'));" onkeypress="focusNext( 'tahun', event, 'bulan', this)" /></td>
	</tr>
</table>
</form>
</div>
...
<img src="<?=IMAGES_URL?>printer.gif" alt="Cetak" onclick="cetak('<?=URL?>rekmed/lap_rl2a1_cetak/',1000,768);" class="printer_button" />
</div>
<h2 id="title"></h2>
