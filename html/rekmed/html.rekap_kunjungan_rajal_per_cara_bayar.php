...
<img src="<?=IMAGES_URL?>printer.gif" alt="Cetak" onclick="cetak('<?=URL?>rekmed/rekap_kunjungan_rajal_per_cara_bayar_cetak/', 1000);" class="printer_button" />
</div>
<h2 id="title"></h2>
