...
<form method="post" action="<?$_SERVER['PHP_SELF']?>" name="lap_rl2c" id="lap_rl2c" onsubmit="return false;">
<table cellpadding="0" cellspacing="2" border="0" class="form">
	...
	<tr>
		<td colspan="2" style="text-align: center;"><input type="button" name="cari" id="cari" value="Tampilkan" class="inputan" onclick="xajax_get_lap_rl2c(xajax.getFormValues('lap_rl2c'));" onkeypress="focusNext( 'tahun', event, 'bulan', this)" /></td>
	</tr>
</table>
</form>
</div>
...
<img src="<?=IMAGES_URL?>printer.gif" alt="Cetak" onclick="cetak('<?=URL?>rekmed/lap_rl2c_cetak/',800,768);" class="printer_button" />
</div>
<h2 id="title"></h2>
