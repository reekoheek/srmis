...
<table cellpadding="0" cellspacing="2" border="0" class="form">
	<tr>
		<td style="width: 150px;">Poliklinik</td><td>
			<select id="pelayanan_id" name="pelayanan_id" class="inputan" onkeypress="focusNext( 'jangka_waktu', event, 'cari', this)" style="width:200px">
	...
	<tr>
		<td colspan="2" style="text-align: center;"><input type="button" name="cari" id="cari" value="Tampilkan" class="inputan" onclick="xajax_get_penyakit_check(xajax.getFormValues('sepuluh_besar'));" onkeypress="focusNext( 'pelayanan_id', event, 'tampilkan', this)" /></td>
	</tr>
</table>
</form>
</div>
...
<img src="<?=IMAGES_URL?>printer.gif" alt="Cetak" onclick="cetak('<?=URL?>rekmed/statistik_penyakit_rajal_cetak/');" class="printer_button" /></div>
<h2 id="title"></h2>
