...
<form method="post" action="<?$_SERVER['PHP_SELF']?>" name="lap_rl3" id="lap_rl3" onsubmit="return false;">
<table cellpadding="0" cellspacing="2" border="0" class="form">
	<tr>
		...
		<td>
				...
				$thn_skr = date("Y");
				?>
			<select name="tahun" id="tahun" style="width: 70px;" onkeypress="focusNext( 'cari', event, 'cari', this)" class="inputan">
	...
	<tr>
		<td colspan="2" style="text-align: center;"><input type="button" name="cari" id="cari" value="Tampilkan" class="inputan" onclick="xajax_get_jml_tt(xajax.getFormValues('lap_rl3'));" onkeypress="focusNext( 'tahun', event, 'tahun', this)" /></td>
	</tr>
</table>
</form>
</div>
...
<img src="<?=IMAGES_URL?>printer.gif" alt="Cetak" onclick="cetak('<?=URL?>rekmed/lap_rl3_cetak/',800,768);" class="printer_button" />
</div>
<h2 id="title"></h2>
...
<table cellpadding="0" cellspacing="0" border="0" style="width: 20.5cm;">
	<tr>
		<td>
			...
			<div id="list_data_2" style="border:solid 1px #000000;width: 100%;"></div>
