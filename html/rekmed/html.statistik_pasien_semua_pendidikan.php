...
<h3><?=$_TITLE;?></h3>
<div id="div_statistik_pasien_semua_pendidikan">
<form method="post" action="<?$_SERVER['PHP_SELF']?>" name="statistik_pasien_semua_pendidikan" id="statistik_pasien_semua_pendidikan" onsubmit="return false;">
<table cellpadding="0" cellspacing="2" border="0" class="form">
	...
	<tr>
		<td colspan="2" style="text-align: center;"><input type="button" name="cari" id="cari" value="Tampilkan" class="inputan" onclick="xajax_get_pasien_check(xajax.getFormValues('statistik_pasien_semua_pendidikan'));" onkeypress="focusNext( 'jangka_waktu', event, 'tgl_periksa_thn_end', this)" /></td>
	</tr>
</table>
</form>
</div>
...
<div style="text-align:right;width:100%;">
	<img src="<?=IMAGES_URL?>printer.gif" alt="Cetak" onclick="cetak('<?=URL?>rekmed/statistik_pasien_semua_pendidikan_cetak/');" class="printer_button" />
</div>
<h2 id="title"></h2>
...
Klik salah satu tingkat pendidikan untuk mendapatkan list pasien.
</div>
