...
<form method="post" action="<?$_SERVER['PHP_SELF']?>" name="lap_rl2b" id="lap_rl2b" onsubmit="return false;">
<table cellpadding="0" cellspacing="2" border="0" class="form">
	...
	<tr>
		<td colspan="2" style="text-align: center;"><input type="button" name="cari" id="cari" value="Tampilkan" class="inputan" onclick="xajax_get_lap_rl2b(xajax.getFormValues('lap_rl2b'));" onkeypress="focusNext( 'tahun', event, 'tw', this)" /></td>
	</tr>
</table>
</form>
</div>
...
<img src="<?=IMAGES_URL?>printer.gif" alt="Cetak" onclick="cetak('<?=URL?>rekmed/lap_rl2b_cetak/',800,768);" class="printer_button" />
</div>
<h2 id="title"></h2>
