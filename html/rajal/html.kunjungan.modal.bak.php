...
<table cellpadding="5" cellspacing="0" border="0" style="width:100%">
		...
		<td style="width:50%">
			...
			<table cellpadding="0" cellspacing="5" border="0" class="form">
				...
				<tr>
					<td>Dokter*</td>
					<td>
						<select name="input_dokter_id" id="input_dokter_id" style="width: 250px;" onkeypress="focusNext('input_kelanjutan', event, 'input_simpan', this)" class="inputan">
	...
	<tr>
		...
		<input type="button" name="input_simpan" id="input_simpan" value="Simpan" class="inputan" onclick="xajax_simpan_kunjungan_check(xajax.getFormValues('input_kunjungan'));" onkeypress="focusNext('input_dokter_id', event, 'input_keadaan_keluar', this)" />&nbsp;&nbsp;
