...
<div class="modal_title_bar">Pembayaran Angsuran</div>
...
<input type="hidden" name="lb_id_kwitansi" id="lb_id_kwitansi" />
			...
			<legend>Pembayaran</legend>
				<table cellpadding="2" cellspacing="2" border="0" style="width:100%">
					...
					<tr>
						...
						<input type="button" name="lb_cancel" id="lb_cancel" value="Tutup" class="inputan" onclick="tutup_modal_lb();" /> </td>
					</tr>
				</table>
			</fieldset>
			<br />
