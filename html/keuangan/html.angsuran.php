...
<table cellpadding="0" cellspacing="2" border="0" class="form">
	...
	<tr>
		...
		<fieldset>
		<legend>Pencarian Berdasarkan Pembayaran Sebelumnya</legend>
			<table cellpadding="0" cellspacing="2" border="0" class="form">
				<tr>
					<td style="width:150px;">Nomor Kwitansi</td>
					<td><input type="text" name="kwitansi_id" id="kwitansi_id" size="20" maxlength="8" class="inputan" onkeypress="focusNext( 'cari2', event, 'cari2', this)" />&nbsp;<input type="button" name="cari2" id="cari2" value="Cari" class="inputan" onclick="xajax_list_data('0',xajax.getFormValues('form_kunjungan'));" onkeypress="focusNext( 'kwitansi_id', event, 'kwitansi_id', this)" /><br /><i>masukkan hanya angka saja. misal : 254</i></td>
				</tr>
			</table>
		</fieldset>
		</td>
...
<? include_once "html.langsung_bayar_angsuran.modal.php"; ?>
