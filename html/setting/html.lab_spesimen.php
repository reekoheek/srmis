...
<table cellpadding="0" cellspacing="2" border="0" class="form">
	...
	<tr>
		<td>Biaya</td><td>
			<input type="text" name="biaya" id="biaya" class="inputan" onkeypress="focusNext( 'tingkat', event, 'kelas', this)" /></td>
	</tr> 
	<tr>
	...
	<tr>
		<td colspan="2" style="text-align: center;"><input type="button" name="simpan" id="simpan" value="Simpan" class="inputan" onclick="xajax_simpan_lab_check(xajax.getFormValues('form_kamar'));" onkeypress="focusNext( 'pelayanan_id', event, 'jml_bed', this)" />&nbsp;&nbsp;
