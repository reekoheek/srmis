<div id="modal_daftar_ranap" class="window_modal" style="display:none;left:20px;top:20px;width:70%;">
<div class="modal_button_group"><img src="<?=IMAGES_URL?>close.png" alt="Tutup" onclick="xajax_tutup_daftar_ranap();" /></div>
<div class="modal_title_bar" id="judul_daftar_ranap"></div>
<form method="post" action="<?$_SERVER['PHP_SELF']?>" name="daftar_ranap" id="daftar_ranap" onsubmit="return false;">
...
<table cellpadding="5" cellspacing="0" border="0" style="width:100%">
	...
	<tr>
		<td colspan="2">
			...
			<table cellpadding="0" cellspacing="5" border="0" class="form">
				<tr>
					<td style="width:150px;">Bangsal<font color="red">*</font></td>
					<td>
						<select name="pelayanan_id" id="pelayanan_id" style="width: 200px;" onkeypress="focusNext('kamar_id', event, 'pj_hubungan_keluarga', this)" class="inputan" onchange="xajax_ref_get_kamar('kamar_id', this.value);get_info_kamar(this);xajax_ref_get_dokter('dokter_id', this.value);xajax_ref_get_bed('no_kamar', this.value);">
						<option value="">--- PILIH ---</option>
						</select>
					</td>
				</tr>
				<tr>
					<td>Kamar<font color="red">*</font></td>
					<td>
						<select name="kamar_id" id="kamar_id" style="width: 200px;" onkeypress="focusNext('no_kamar', event, 'pelayanan_id', this)" class="inputan" onchange="xajax_ref_get_no_kamar('no_kamar', this.value);">
							<option value="">--- PILIH ---</option>
						</select>
					</td>
				</tr>
   	            <tr>
					<td>No Bed<font color="red">*</font></td>
					<td>
				...
				<tr>
					...
					<td>
						...
						<select name="tgl_keluar_mnt" id="tgl_keluar_mnt" style="width: 50px;" onkeypress="focusNext( 'tgl_keluar_dtk', event, 'tgl_keluar_jam', this)" class="inputan">
							<? for($i=0;$i<60;$i++) :
									$mnt = tambahNol($i, 2);
						...
						<select name="tgl_keluar_dtk" id="tgl_keluar_dtk" style="width: 50px;" onkeypress="focusNext( 'simpan', event, 'tgl_keluar_mnt', this)" class="inputan">
							<? for($i=0;$i<60;$i++) :
								$dtk = tambahNol($i, 2);
									if($dtk==$dtk_skr) $sel = "selected";
									else $sel = "";
							?>
								<option value="<?=$dtk?>" <?=$sel?> ><?=$dtk?></option>
							<? endfor; ?>
						</select>
	...
	<tr>
		...
		<input type="button" name="simpan" id="simpan" value="Simpan" class="inputan" onclick="xajax_simpan_daftar_ranap_check(xajax.getFormValues('daftar_ranap'));" onfocus="hide_info_kamar();" />&nbsp;&nbsp;
		<input type="button" name="cancel" id="cancel" value="Tutup" class="inputan" onclick="xajax_tutup_daftar_ranap();" /> </td>
	</tr>
</table>
</form>
</div>