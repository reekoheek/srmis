...
<div style="text-align:left;width:100%;">
	<a href="javascript:void(0)" title="" onclick="show_hide_form();"><img src="<?=IMAGES_URL?>search.png" alt="Search Pasien" border="0" name="gbr_cari" id="gbr_cari" /></a> <b><<=PENCARIAN PASIEN</b>
</div>
<div id="form_tambah">
	...
	<tr>
		<td style="width:50%;">
			...
			<table cellpadding="0" cellspacing="4" border="0" class="form">
                ...
                <tr>
					<td>NO KTP/SIM</td>
					<td><input type="text" name="no_ktp_sim" id="no_ktp_sim" value="" class="inputan" onkeypress="focusNext( 'usia_tahun', event, 'id', this)" size="50" /></td>
				</tr>
				<tr>
		...
		<td>
			<table cellpadding="0" cellspacing="4" border="0" class="form">
				...
				<tr>
					...
					<td>
						<select name="desa_id" id="desa_id" style="width: 200px;" class="inputan" onchange="add_desa_combo(this.value);">
							<option value="">--- PILIH ---</option>
						</select>
					</td>
				</tr>
...
<table cellpadding="0" cellspacing="0" border="0" style="width:100%;">
	<tr>
			...
			<table cellpadding="0" cellspacing="4" border="0" class="form">
				<tr>
					...
					<td>
						...
						<select name="tgl_periksa_thn" id="tgl_periksa_thn" style="width: 60px;" onkeypress="focusNext( 'kamar_id', event, 'tgl_periksa_bln', this);" class="inputan">
				...
				<tr>
					<td>Poliklinik<font color="red">*</font></td><td>
						<select name="kamar_id" id="kamar_id" style="width: 200px;" onkeypress="focusNext('dokter_id', event, 'tgl_periksa_thn', this);" class="inputan" onchange="xajax_ref_get_dokter_from_kamar('dokter_id', this.value);">
							<option value="">--- PILIH ---</option>
				...
				<tr>
					<td>Dokter<font color="red">*</font></td><td>
						<select name="dokter_id" id="dokter_id" style="width: 200px;" onkeypress="focusNext('cara_masuk', event, 'kamar_id', this);" class="inputan">
							<option value="">--- PILIH ---</option>
						</select>
					</td>
				</tr>
				<tr>
					<td>Cara Masuk<font color="red">*</font></td><td>
						<select name="cara_masuk" id="cara_masuk" style="width: 200px;" onkeypress="focusNext('perujuk_id', event, 'dokter_id', this)" class="inputan" onchange="xajax_ref_get_perujuk('perujuk_id', this.value, '', true)" onfocus="hide_info_jadwal_dokter();xajax_get_no_antrian(xajax.getFormValues('tambah_pasien'));" >
						<option value="">--- PILIH ---</option>
				...
				<tr id="tr_no_antrian" style="display:none;">
					<td style="color:red;font-weight:bold;">No. Antrian</td>
					<td>
						
						  <input type="text" name="no_antrian" id="no_antrian" value="" class="inputan" onkeypress="focusNext( 'no_antrian', event, 'div_no_antrian', this)" />
		...
		<td>
			<table cellpadding="0" cellspacing="4" border="0" class="form">
				<tr>
					<td style="width:150px">Cara Bayar<font color="red">*</font></td>
					<td>
...
<input type="reset" name="baru" id="baru" value="Tambah Baru" class="inputan" accesskey="N" onclick="xajax_reset_pasien(); fokus('id');" onkeypress="focusNext( 'id', event, 'simpan', this)" />&nbsp;&nbsp;<input type="button" name="cetak" id="cetak" value="Cetak Form" class="inputan" onclick="xajax_cetak_form();"/></div>
