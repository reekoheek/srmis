...
<table cellpadding="0" cellspacing="2" border="0" class="form">
	...
	?>
	<tr>
		<td style="width: 150px">Poliklinik</td>
		<td>
			<select name="pelayanan_id" id="pelayanan_id" style="width:200px;" onkeypress="focusNext( 'tgl_mulai_tgl', event, 'tampil', this)" class="inputan">
...
<div class="info">Petunjuk:
Klik salah satu kunjungan untuk merubah data kunjungan
</div>
<? include_once "html.kunjungan_rajal.modal.php"; ?>
