...
<table cellpadding="5" cellspacing="0" border="0" style="width:100%">
	...
	<tr>
		<td style="width:50%">
			...
			<table cellpadding="0" cellspacing="5" border="0" class="form">
				<tr>
					<td style="width: 150px;">Klinik*</td>
					<td colspan="2">
						<select name="input_kamar_id" id="input_kamar_id" style="width: 200px;" onkeypress="focusNext('input_dokter_id', event, 'input_simpan', this)" class="inputan" onchange="xajax_ref_get_dokter_from_kamar('input_dokter_id', this.value);">
	...
	<tr>
		...
		<input type="button" name="input_simpan" id="input_simpan" value="Simpan" class="inputan" onclick="xajax_simpan_kunjungan_check(xajax.getFormValues('input_kunjungan'));" onkeypress="focusNext( 'input_kamar_id', event, 'input_pj_hubungan_keluarga', this)" />&nbsp;&nbsp;
