...
<table cellpadding="0" cellspacing="0" border="0" style="overflow: hidden; width: 8.5cm; height: 5cm; border: 1pt solid #000000; padding: 2mm 2mm 2mm 2mm;">
	...
	<tr>
		<td colspan="3" style="vertical-align:top;text-align:center;">
			<div style="font-size:10pt;font-weight:bold;">KARTU BEROBAT</div>
		</td>
	</tr>
    	<tr>
		<td><B>No RM</B></td>
		<td>:</td>
		<td><div style="font-weight:bold;font-size:10pt;text-align:center;border:solid 1px #000000;line-height:30pt;"><?=$data[no_rm]?></div></td>
	</tr>
	<tr>
		<td><B>Nama</B></td>
		<td>:</td>
