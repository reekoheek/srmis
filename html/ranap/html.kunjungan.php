...
<table cellpadding="0" cellspacing="2" border="0" class="form">
	...
	<tr>
		...
		<fieldset>
			<legend>List Pasien per Kamar</legend>
			<table cellpadding="0" cellspacing="2" border="0" class="form">
				<tr>
					<td style="width:150px;">Bangsal</td>
					<td><select id="bangsal" name="bangsal" class="inputan" onkeypress="focusNext( 'nama', event, 'simpan', this)" style="width:100px" onchange="xajax_list_data('0',xajax.getFormValues('form_kunjungan'));">
...
<input type="hidden" name="dp_kelas" id="dp_kelas" />
