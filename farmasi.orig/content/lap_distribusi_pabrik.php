...
$namaFile = "lap_distribusi_pabrik.xls";
...
xlsWriteLabel(0,0,"DISTRIBUSI PABRIK OBAT $nama_pabrik, Tertanggal : $tgl_mulai - $tgl_selesai")->MergeCells = True;  
...
$query = "SELECT * FROM permintaan_unitdetail,permintaan_unit,pelayanan,ms_barang WHERE permintaan_unit.No_SPP=permintaan_unitdetail.No_SPP AND 
		  permintaan_unitdetail.Unit=pelayanan.id AND permintaan_unitdetail.status_detail <> '0' AND permintaan_unit.create_date BETWEEN '$tanggal_start' AND '$tanggal_end'  AND permintaan_unitdetail.barang_id = ms_barang.id AND ms_barang.pabrik_obat = '$kd_pabrik'
