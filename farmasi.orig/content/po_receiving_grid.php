...
<tr>
    <td>
        ...
        ?>
                    ...
                    <td align='center'><input type ='text' maxlength='5' size=8 name='txtSat<?=$no?>'  value='<?=$exQueryDet[po_satuan]?>' /></td>
                    <td align='center'><input type ='text' maxlength='4' size=8 name='txtQty<?=$no?>'  value='<?=$exQueryDet[po_qty]?>' onblur="document.frmPOCreate.txtSubtotal<?=$no?>.value= (document.frmPOCreate.txtHarga<?=$no?>.value * document.frmPOCreate.txtQty<?=$no?>.value) ;"/></td>
                    ...
                    <td align='center'><input type ='text' maxlength='3' size=5 name='txtDisc<?=$no?>'  value='<?=$exQueryDet[po_discount]?>' onblur="document.frmPOCreate.txtADisc<?=$no?>.value=(document.frmPOCreate.txtHarga<?=$no?>.value * (document.frmPOCreate.txtDisc<?=$no?>.value * (10/100)));" /></td>
                    <td align='center'><input type ='text' name='txtADisc<?=$no?>' size=15  value='<?=$exQueryDet[po_discammount]?>' onfocus="document.frmPOCreate.txtSubtotal<?=$no?>.value=(document.frmPOCreate.txtHTotal.value - document.frmPOCreate.txtADisc<?=$no?>.value) ;" /></td>
                    <td align='center'><input type ='text' name='txtSubtotal<?=$no?>' size=15  value='<?=$exQueryDet[po_subtotal]?>' />
