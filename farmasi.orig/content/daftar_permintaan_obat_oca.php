				...
				<tr>
					...
					<table border="0" cellpadding="2" cellspacing="2" width="100%">
						<tr>
							<td align="right">
								<div id="container">
								<form method="post" action="home.php?hal=content/daftar_permintaan_obat_oca" enctype="multipart/form-data">
							...
							<td>
								...
								/*	$qms=mysql_query("select * from ms_barang where id='$result[barang_id]'");
										...
										echo "<td width=70px>$result[kd_barang]</td>";
											...
											<form method=post action='home.php?hal=content/input_permintaan_obat_oca' enctype=multipart/form-data>
									...
									{
   										$page = $pageNum - 1;
   								   	 	$prev = " <a href=\"$self?page=$page&hal=content/daftar_permintaan_obat_oca&no_SPP=$no_SPP&tgl=$tgl&id=$id\"><font color='#565957' size=-1>[&laquo;]</font></a> ";

    									$first = " <a href=\"$self?page=1&hal=content/daftar_permintaan_obat_oca&no_SPP=$no_SPP&tgl=$tgl&id=$id\"><font color='#565957' size=-1>[&laquo;&laquo;]</font></a> ";
									}
									else
									{
   			 							$prev  = ' [&laquo;] ';
									...
									{
    									$page = $pageNum + 1;
    									$next = " <a href=\"$self?page=$page&hal=content/daftar_permintaan_obat_oca&no_SPP=$no_SPP&tgl=$tgl&id=$id\"><font color='#565957' size=-1>[&raquo;]</font></a> ";

    									$last = " <a href=\"$self?page=$maxPage&hal=content/daftar_permintaan_obat_oca&no_SPP=$no_SPP&tgl=$tgl&id=$id\"><font color='#565957' size=-1>[&raquo;&raquo;]</font></a> ";
									}
									else
									{
   										$next = ' [&raquo;] ';
