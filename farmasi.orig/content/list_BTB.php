			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<table border="0" cellpadding="2" cellspacing="2" width="100%">
						<tr>
							<form method="post" action="home.php?hal=content/list_BTB" enctype="multipart/form-data">
							<td align="right">
						  <!--
						...
						<tr>
							...
							<?php
									...
									if ($cari)
									{
										...
										{
											$query2  = mysql_query ("SELECT * FROM permintaan_unit where No_BPB like '$cari%' ORDER BY No_BPB DESC");	
										}
										else
										{
											$query2  = mysql_query ("SELECT * FROM permintaan_unit where Unit='".$_SESSION['U_SUBUNIT']."' AND No_BPB like '$cari%' ORDER BY No_BPB DESC");
										}
									}
									else
									{
										...
										{
											$query2  = mysql_query ("SELECT * FROM permintaan_unit WHERE Unit='".$_SESSION['U_SUBUNIT']."' ORDER BY No_BTB DESC");	
										}
									}
							...
							echo '<table border=0 cellpadding=2 cellspacing=2 width=100%>
									...
									if (!empty($result2['No_BPB']))
									{
										...
										echo "<td align=center width=80px>$result2[tgl_bpb]</td>
											...
											{
												echo "<td align=center><a href='home.php?hal=action/insert_btb&No_SPP=$result2[No_SPP]&UsrBuat=".$_SESSION['U_USER']."' style=visibility:hidden>Terima Barang</a></td>";
											}
											elseif (($result2['status']==2 or $result2['status']==8 ) AND ($result2['Unit'] == $_SESSION['U_SUBUNIT']))
											{
												echo "<td align=center><a href='home.php?hal=action/insert_btb&No_SPP=$result2[No_SPP]&UsrBuat=".$_SESSION['U_USER']."'>Terima Barang</a></td>";
											}
											else
											{
												echo "<td align=center><a href='home.php?hal=action/insert_btb&No_SPP=$result2[No_SPP]&UsrBuat=".$_SESSION['U_USER']."' style=visibility:hidden>Terima Barang</a></td>";
