		...
		<td id="tengah_isi" >
			...
			<table border="0" cellpadding="0" cellspacing="0" width="85%">
				<tr>
					...
					<form method="post" enctype="multipart/form-data" action="home.php?hal=action/insert_resep_reg_igd">
					<table border="0" cellpadding="2" cellspacing="2" width="100%">
						...
						<tr>
							...
							<td><input type="text" name="stok" disabled size="7"  id="inputString2" onKeyUp="lookup(this.value);" onblur="fill();">
