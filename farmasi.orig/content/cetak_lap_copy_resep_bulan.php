...
<table border="0" cellpadding="2" cellspacing="2" width="800px" align="center">
	<tr>
		<td align="center" colspan="4"><font color="#000000" size="+1"><strong>LAPORAN COPY RESEP BARANG PER BULAN<br></strong></font></td>
	</tr>
	<tr>
		...
		<td colspan="4" align="center">
			...
			echo '<table border=1 cellpadding=2 cellspacing=2 width=100% bordercolor=#FF9933>
					<tr bgcolor=#FEFAFA align=center>
						...
						<td><font color=#000000>Tanggal</font></td>
			...
			$q3=mysql_query("SELECT SUM(jumlah_harga) FROM copy_resep WHERE month = '".$_POST['month']."' 
			AND year = '".$_POST['year']."'");
