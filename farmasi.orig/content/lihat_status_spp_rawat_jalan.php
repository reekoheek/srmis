...
$rar=mysql_fetch_array($qar);
		...
		if ($r)
		{
			print "<script>location.href='home.php?hal=content/list_BTB_rawat_jalan'</script>";
		}
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		...
		<table border="0" width="100%" cellpadding="0" cellspacing="0">
			<tr>
				<td width="8px">&nbsp;</td>
				<td width="300px" bgcolor="#9b9999">&nbsp;&nbsp;<b><font color="#fefafa" style="font-size:14px;">Daftar APPROVAL Permintaan </font></b></td>
				<td></td>
			</tr>
		</table>
		</td>
							...
							echo "<div style='border:1px  solid  #CCCCCC; width:670px; height:200px; overflow:auto;'>";
								echo '<table cellpadding=2 cellspacing=2 width=100%>
									<tr bgcolor=#414141 align=center>
										...
										<td><font color=#FFFFFF width=60px>Status</font></td>
									...
									while ($result2 = mysql_fetch_array($query2))
									{
										...
										echo "<td width=70px>$result2[kd_barang]</td>
											...
											echo "<td width=120px align='center'>".$rstatus['nama']."</td>";
											...
											<a href='javascript:void(0);' onClick=\"PopupCenter('content/input_buat_retur_rawat_jalan.php?UsrRetur=$UsrRetur&No_SPP=$result2[No_SPP]&id=$result2[id]', 'myPop1',800,400);\">BUAT RETUR</a>
											| 									
											<a href='home.php?hal=action/terima_barang_rawat_jalan&id=$result2[barang_id]&id=$result2[id]&id_ms=$result2[0]&No_SPP=$result2[No_SPP]&No_BTB=$rar[No_BTB]&No_BPB=$rar[No_BPB]'>Received</a>
											</td>";
											}
							...
							<td>
								...
								<table width="100%">
									...
									<td align="right" valign="top">
										...
										{
										?>
											<form method="post" enctype="multipart/form-data" action="home.php?hal=action/terima_barang_unit_rawat_jalan">
