...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
	<tr>
		...
		<table border="0" width="100%" cellpadding="0" cellspacing="0">
			<tr>
				<td width="8px">&nbsp;</td>
				<td width="300px" bgcolor="#9b9999">&nbsp;&nbsp;<b><font color="#fefafa">Input Jurnal Penyesuaian </font></b></td>
				<td></td>
			</tr>
		</table>
		</td>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<table border="0" cellpadding="2" cellspacing="2" width="100%">
						<tr>
							<td align="center">
	<form id="form1" name="form1" method="post" action="home.php?hal=action/simpan_jurnal_penyesuaian_detail">
...
<td valign="top">
							...
							<tr>
							<td align="right"><form method="post" action="home.php?hal=content/jurnal_penyesuaian">
								<input type="submit" value="Jurnal Penyesuaian" name="jurnal" size="70%">
							</form>
							</td>
							</tr>
							</table>
