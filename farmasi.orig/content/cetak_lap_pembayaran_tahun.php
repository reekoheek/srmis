...
<table border="0" cellpadding="2" cellspacing="2" width="800px" align="center">
	<tr>
		<td align="center" colspan="4"><font color="#000000" size="+1"><strong>LAPORAN PEMBAYARAN COPY RESEP BARANG PER TAHUN<br></strong></font></td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="4" align="center">
			...
			$q3=mysql_query("SELECT SUM(jumlah_harga) FROM lunas WHERE year = '".$_POST['year']."'");
