...
SIK : KP 01.01.1.3.13059</span></font></div></td>
  ...
  <tr>
    ...
    <td><font size="1">:</font></td>
    <td><font size="1"><? echo $nama; ?></font></td>
	<td>&nbsp;</td>
  </tr>
  <tr>
    <td><span class="style2">Pembayaran </span></td>
    <td><font size="1">:</font></td>
	<? if($jenis_ket=="KARYAWAN - BON"){
	?>
    <td><font size="1">KARYAWAN - BON</font></td>
	<? }else if($jenis_ket=="KARYAWAN - CASH"){ ?>
	<td><font size="1">KARYAWAN - CASH</font></td>
	<? }else{ ?>
	<td><font size="1">Tunai</font></td>
	<? } ?>
	<td>&nbsp;</td>
  </tr>
  ...
  while ($d_trans = mysql_fetch_array($q_trh))
	{
		if($d_trans['racikan']=='YA')
		{
		 ...
		 $qdor=mysql_query("select * from dosis where id='$r_rck[dosis_id]'");
			$rdor=mysql_fetch_array($qdor);
		 echo "<td><font size=1>$rdor[deskripsi]</font></td>";
		 echo "<td><font size=1>1</font></td>";
		 echo "<td><font size=1>$r_rck[ket]</font></td>";
...
?>
	...
	<tr><td colspan="3" align="left"><font size="1">Petugas : <? echo $_SESSION['U_USER']; ?></font></td><td>&nbsp;</td></tr>
						...
						<tr><td colspan="3"><div align="center" class="style4">
						  <p>SILAHKAN BAYAR OBAT ANDA DI KASIR</p>
