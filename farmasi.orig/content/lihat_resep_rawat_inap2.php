						...
						<tr>
							...
							while($r1=mysql_fetch_array($q1))
							{
							 ...
							 echo"<td align=center>$r1[tgl]</td> 
							 	<td align=center><a href='../action/to_preview_resep_rawat_inap2.php?no_resep=$r1[no_resep]&no_trans=$no_trans&param_no=$param_no'>$r1[no_resep]</a></td>";
							 ...
							 echo"	<td align=left>$r2[nama]</td>
									...
									<td align=center><a href='../action/insert_resep_to_kasir2.php?no_resep=$r1[no_resep]&no_trans=$no_trans&param_no=$param_no&pasien_id=$r1[pasien_id]&namapas=$r2[nama]'>Bayar</a></td>
									</tr>";
									$no++;
							}
