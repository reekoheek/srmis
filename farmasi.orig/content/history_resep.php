		...
		<td id="tengah_isi" >
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<form method="post" action="home.php?hal=content/history_resep&id=<?=$id?>&nama=<?=$nama?>" enctype="multipart/form-data">
					<table border="0" cellpadding="2" cellspacing="2" width="100%">
						...
						<tr>
						  ...
						  <td><input type="text" name="jenis" value="<?= $re['cara_bayar'] ?>" readonly="true" size="30" style="background-color:#CCCFFF; ">                            </td>
						  <td width="220px">
						  	<table border="0" cellpadding="0" cellspacing="0" width="100%">
								<tr>
									...
									<td>&nbsp;
								    <input name="submit" type="submit" value="Cari">									  &nbsp;</td>
							</form>
									<td>
					...
					<hr>
					<div style="border:0px  solid; border-color:#CCCCCC; width:670px; height:500px; overflow:auto;">
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tr>
							<td>
								<?php
									...
									echo "<table border=0 cellpadding=2 cellspacing=2 width=1100px style='border:1px  solid; border-color:#CCCCCC';>
