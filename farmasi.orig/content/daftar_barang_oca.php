				...
				<tr>
					...
					<tr valign="top">
							<td align="Left" height="27px">
								<div id="container">
								<form method="post" action="home.php?hal=content/daftar_barang_oca" enctype="multipart/form-data">
					          ...
					          <!--
								<input type="button" src="javascript:void(0);" onClick="PopupCenter('content/input_daftar_barang_oca.php', 'myPop1',400,400);" value="Tambah Data">
								--></td>
							<td align="right"><?php
									echo '<form method=post action=home.php?hal=action/insert_spp_oca enctype=multipart/form-data>';
						...
						<tr>
							<td>
								<?php
									...
									{
   										$page = $pageNum - 1;
   								   	 	$prev = " <a href=\"$self?page=$page&hal=content/daftar_barang_oca\"><font color='#565957' size=-1>[&laquo;]</font></a> ";

    									$first = " <a href=\"$self?page=1&hal=content/daftar_barang_oca\"><font color='#565957' size=-1>[&laquo;&laquo;]</font></a> ";
									}
									else
									{
   			 							$prev  = ' [&laquo;] ';
									...
									{
    									$page = $pageNum + 1;
    									$next = " <a href=\"$self?page=$page&hal=content/daftar_barang_oca\"><font color='#565957' size=-1>[&raquo;]</font></a> ";

    									$last = " <a href=\"$self?page=$maxPage&hal=content/daftar_barang_oca\"><font color='#565957' size=-1>[&raquo;&raquo;]</font></a> ";
									}
									else
									{
   										$next = ' [&raquo;] ';
						...
						<tr>
							<td>
								<?php
									...
									{
   										$page2 = $pageNum2 - 1;
   								   	 	$prev2 = " <a href=\"$self2?page=$page2&hal=content/daftar_barang_oca\"><font color='#565957' size=-1>[&laquo;]</font></a> ";

    									$first2 = " <a href=\"$self2?page=1&hal=content/daftar_barang_oca\"><font color='#565957' size=-1>[&laquo;&laquo;]</font></a> ";
									}
									else
									{
   			 							$prev2  = ' [&laquo;] ';
									...
									{
    									$page2 = $pageNum2 + 1;
    									$next2 = " <a href=\"$self2?page=$page2&hal=content/daftar_barang_oca\"><font color='#565957' size=-1>[&raquo;]</font></a> ";

    									$last2 = " <a href=\"$self2?page=$maxPage2&hal=content/daftar_barang_oca\"><font color='#565957' size=-1>[&raquo;&raquo;]</font></a> ";
									}
									else
									{
   										$next2 = ' [&raquo;] ';
