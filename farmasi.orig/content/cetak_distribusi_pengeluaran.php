...
<body>
<div style="border:0px  solid  #CCCCCC; width:100%; height=400px; overflow:auto;">
<table width="90%" align="center">
	<tr>
		<td align="right"><input class="noPrint" type="button" value="Print" onclick="window.print()"></td>
	</tr>
</table>
<?php
...
if ($unit=="")
{
	$qar = mysql_query ("SELECT * FROM permintaan_unit WHERE tgl_bpb='$tgl' AND status=2");
}
else
{
	$qar = mysql_query ("SELECT * FROM permintaan_unit WHERE tgl_bpb='$tgl' AND status=2 AND Unit='$unit'");
}
while ($rar = mysql_fetch_array($qar))
{
...
?>
<center><fieldset style="width:90%;"><legend style="background-color:#9b9999;"><b><font color="#fefafa" style="font-size:14px;">&nbsp;&nbsp;Bukti Pengeluaran Barang&nbsp;&nbsp;</font></b></legend>
								...
								echo '<table cellpadding=2 cellspacing=2 width=100%>
									...
									while ($result2 = mysql_fetch_array($query2))
									{
										...
										echo "<td width=15px>$no</td>
											<td width=70px>$result2[kd_barang]</td>
