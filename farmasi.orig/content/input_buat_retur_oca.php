...
<?php
		...
		if ($_POST['in']==1)
	{
		...
		//echo "dapet";
		$hehe=1;
		print "<script>alert('Data Berhasil di Input');location.href='input_buat_retur_oca.php?No_SPP=$No_SPP&hehe=$hehe'</script>";
...
<form method="post" name="form" action="input_buat_retur_oca.php?No_SPP=<?=$rar2['No_SPP']?>&id=<?=$rar2['id']?>&in=1">
