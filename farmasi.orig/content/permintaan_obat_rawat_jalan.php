		...
		<td id="tengah_isi" >
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					...
					<table border="0" cellpadding="2" cellspacing="2" width="100%">
					  ...
					  <tr>
						...
						<td width="70px" align="right">
						  <form method="post" enctype="multipart/form-data" action="home.php?hal=content/input_permintaan_obat_rawat_jalan">
					...
					<form method="post" action="home.php?hal=content/list_spb_rawat_jalan" enctype="multipart/form-data" id="form1" name="form1">
					<input type="hidden" name="no_SPP" value="<?= $_GET['No_SPP']?>">
							<input type="hidden" name="id" value="<?= $id?>">
							<input type="hidden" name="tgl" value="<?= $_GET['Tgl_SPP']?>">
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
									...
									while ($result2 = mysql_fetch_array($query2))
									{
										...
										echo "<td width=70px>$result2[kd_barang]</td>
											...
											echo 	"<td align=center width=80px>
													<a href=\"home.php?hal=action/hapus_permintaan_obat_rawat_jalan&kd_barang=$result2[kd_barang]&id=$result2[id]&No_SPP=$result2[No_SPP]&Tgl_SPP=$rar[Tgl_SPP]\" 
						...
						<tr>
							<td>
								...
								<table width="100%">
									...
									<form method="post" enctype="multipart/form-data" action="home.php?hal=action/insert_distribusi_rawat_jalan">
									<input type="hidden" name="no_SPP" value="<?= $_GET['No_SPP']?>">
									<input type="hidden" name="id" value="<?= $id?>">
									<input type="hidden" name="tgl" value="<?= $_GET['Tgl_SPP']?>">
