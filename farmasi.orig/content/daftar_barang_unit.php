				...
				<tr>
					...
					<tr valign="top">
						...
						<?php
							...
							if ($cari)
							{
								$query_rec  = mysql_query ("SELECT * FROM barang_unit,ms_barang WHERE barang_unit.unit_id = '2' AND ms_barang.kd_barang LIKE '$cari%' AND barang_unit.barang_id=ms_barang.id AND barang_unit.stok <= barang_unit.min_stok ORDER BY ms_barang.ex_year,ms_barang.ex_month,ms_barang.ex_date ASC");
							}
							else
							{
								$query_rec  = mysql_query ("SELECT * FROM barang_unit,ms_barang WHERE barang_unit.unit_id = '2' AND barang_unit.barang_id=ms_barang.id  AND barang_unit.stok <= barang_unit.min_stok ORDER BY ms_barang.ex_year,ms_barang.ex_month,ms_barang.ex_date ASC");
							}
							$rec=0;
						...
						<tr>
							<td>
								<?php
									...
									if ($cari)
									{
									$query  = mysql_query ("SELECT * FROM barang_unit,ms_barang WHERE barang_unit.unit_id = '2' AND ms_barang.kd_barang LIKE '$cari%' AND barang_unit.barang_id=ms_barang.id AND barang_unit.stok <= barang_unit.min_stok ORDER BY ms_barang.ex_year,ms_barang.ex_month,ms_barang.ex_date ASC");
									}
									else
									{
									$query  = mysql_query ("SELECT * FROM barang_unit,ms_barang WHERE barang_unit.unit_id = '2' AND barang_unit.barang_id=ms_barang.id  AND barang_unit.stok <= barang_unit.min_stok ORDER BY ms_barang.ex_year,ms_barang.ex_month,ms_barang.ex_date ASC
									...
									echo '<table cellpadding=2 cellspacing=2 width=100% style="border:1px  solid  #CCCCCC; ">
											<tr bgcolor=#414141 align=center>
												...
												<td><font color=#FFFFFF width=60px>Stok Apotik</font></td>
												<td><font color=#FFFFFF width=80px>Stock Gudang</font></td>
									...
									while ($result = mysql_fetch_array($query))
									{
										...
										echo "<td width=70px>$result[kd_barang]</td>
											...
											if ($result[59] == 0)
											{
												echo "<td align=right width=60px><font color=red>$result[59]</font></td>";
											}
											else if ($result['stok_min'] >= $result[59])
											{
												echo "<td align=right width=60px><font color=blue>$result[59]</font></td>";
											}
											else
											{
												echo "<td align=right width=60px>$result[59]</td>";
											}
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						...
						<?php
							...
							if ($cari)
							{
								$query_rec2  = mysql_query ("SELECT * FROM barang_unit,ms_barang WHERE ms_barang.kd_barang LIKE '$cari%' AND barang_unit.unit_id = '2' AND barang_unit.barang_id=ms_barang.id AND barang_unit.stok > barang_unit.min_stok ORDER BY ms_barang.ex_year,ms_barang.ex_month,ms_barang.ex_date ASC");
							}
							else
							{
								$query_rec2  = mysql_query ("SELECT * FROM barang_unit,ms_barang WHERE barang_unit.unit_id = '2' AND barang_unit.barang_id=ms_barang.id  AND barang_unit.stok > barang_unit.min_stok ORDER BY ms_barang.ex_year,ms_barang.ex_month,ms_barang.ex_date ASC");
							}
							$rec2=0;
						...
						<tr>
							<td>
								<?php
									...
									if ($cari)
									{
									$query2  = mysql_query ("SELECT * FROM barang_unit,ms_barang WHERE ms_barang.kd_barang LIKE '$cari%' AND barang_unit.unit_id = '2' AND barang_unit.barang_id=ms_barang.id AND barang_unit.stok > barang_unit.min_stok ORDER BY ms_barang.ex_year,ms_barang.ex_month,ms_barang.ex_date ASC");
									}
									else
									{
									$query2  = mysql_query ("SELECT * FROM barang_unit,ms_barang WHERE barang_unit.unit_id = '2' AND barang_unit.barang_id=ms_barang.id  AND barang_unit.stok > barang_unit.min_stok ORDER BY ms_barang.ex_year,ms_barang.ex_month,ms_barang.ex_date ASC
											   LIMIT $offset, $rowsPerPage");
									}
									...
									while ($result2 = mysql_fetch_array($query2))
									{
										...
										echo "<td width=70px>$result2[kd_barang]</td>
											...
											else if ($result2['max_stok'] >= $result2[3])
											{
											...
											if ($result2[59] == 0)
											{
												echo "<td align=right width=60px><font color=red>$result2[59]</font></td>";
											}
											else if ($result2['stok_max'] >= $result2[59])
											{
												echo "<td align=right width=60px><font color=blue>$result2[59]</font></td>";
											}
											else
											{
												echo "<td align=right width=60px>$result2[59]</td>";
											}
											echo "<td align=right width=80px>";
