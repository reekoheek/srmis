...
$rar=mysql_fetch_array($qar);
		...
		if ($r)
		{
			print "<script>location.href='home.php?hal=content/list_BTB_rawat_inap'</script>";
		}
								...
								echo '<table cellpadding=2 cellspacing=2 width=100%>
									...
									while ($result2 = mysql_fetch_array($query2))
									{
										...
										echo "<td width=70px>$result2[kd_barang]</td>
											...
											<a href='javascript:void(0);' onClick=\"PopupCenter('content/input_buat_retur_rawat_inap.php?UsrRetur=$UsrRetur&No_SPP=$result2[No_SPP]&id=$result2[id]', 'myPop1',800,400);\">BUAT RETUR</a>
											| 									
											<a href='home.php?hal=action/terima_barang_rawat_inap&id=$result2[barang_id]&id=$result2[id]&id_ms=$result2[0]&No_SPP=$result2[No_SPP]&No_BTB=$rar[No_BTB]&No_BPB=$rar[No_BPB]'>Received</a>
											</td>";
											}
							...
							<td>
								...
								<table width="100%">
									...
									<td align="right" valign="top">
										...
										{
										?>
											<form method="post" enctype="multipart/form-data" action="home.php?hal=action/terima_barang_unit_rawat_inap">
