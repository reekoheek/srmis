...
<?php
	...
	$q = mysql_query ("SELECT * FROM penjualan WHERE transaksi = '$_POST[transaksi]'");
	$r = mysql_fetch_array ($q);
	$q2 = mysql_query ("SELECT * FROM pasien WHERE no_rm = '$_POST[no_rm]'");
...
<table border="0" cellpadding="2" cellspacing="2" width="650px" align="center">
	...
	<tr>
		...
		<td><font style="font-size:12px "><?=":" . $r['date'] . "-" .$r['month']. "-" .$r['year'] ?></font></td>
	</tr>
			</table>
		</td>
	</tr>
	...
	<tr>
		<td colspan="6" align="center">
			<?php
			$query = mysql_query("SELECT * FROM penjualan,obat WHERE penjualan.kode_obat = obat.kode_obat AND penjualan.transaksi = '$r[transaksi]'");
			...
			$q3=mysql_query("SELECT SUM(jumlah_harga) FROM penjualan WHERE transaksi = '$r[transaksi]'");
