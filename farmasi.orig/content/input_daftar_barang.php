				...
				<tr>
					...
					<table border="0" cellpadding="2" cellspacing="2" width="100%">
						<tr>
							...
							<td width="3px">:</td>
							<td><input type="hidden" name="id" value="<?= $r['id']?>">
							<select name="group_barang">
						...
						<tr>
						  ...
						  <td align="right">&nbsp;</td>
						  <td align="right"><div align="left"><font color="#FF0000">Expire Date *</font> </div></td>
						  <td>:</td>
						...
						<tr>
						  <td align="right"><div align="left">PBF 01 </div></td>
						  <td>:</td>
						  <td><select name="pabrik01">
                              <option value="">--Pilih--</option>
                              <?php
								$qp1=mysql_query ("SELECT * FROM pbf");
								while ($rp1=mysql_fetch_array($qp1))
								{
									if ($rp1['id'] == $r['pabrik01'])
									{
										echo "<option value='$rp1[id]' selected>$rp1[nama] </option>";
									}
									else
									{
										echo "<option value='$rp1[id]'>$rp1[nama] </option>";
									}
								}
							?>
                            </select>
						...
						<tr>
						  <td align="right"><div align="left">PBF 02 </div></td>
						  <td>:</td>
						  <td><select name="pabrik02">
                              <option value="">--Pilih--</option>
                              <?php
								$qp2=mysql_query ("SELECT * FROM pbf");
								while ($rp2=mysql_fetch_array($qp2))
								{
									if ($rp2['id'] == $r['pabrik02'])
									{
										echo "<option value='$rp2[id]' selected>$rp2[nama] </option>";
									}
									else
									{
										echo "<option value='$rp2[id]'>$rp2[nama] </option>";
									}
								}
							?>
                            </select>
						...
						<tr>
						  <td align="right"><div align="left">PBF 03 </div></td>
						  <td>:</td>
						  <td><select name="pabrik03">
                              <option value="">--Pilih--</option>
                              <?php
								$qp3=mysql_query ("SELECT * FROM pbf");
								while ($rp3=mysql_fetch_array($qp3))
								{
									if ($rp3['id'] == $r['pabrik03'])
									{
										echo "<option value='$rp3[id]' selected>$rp3[nama] </option>";
									}
									else
									{
										echo "<option value='$rp3[id]'>$rp3[nama] </option>";
									}
								}
							?>
                            </select>
						...
						<tr>
						  <td align="right"><div align="left">PBF 04</div></td>
						  <td>:</td>
						  <td><select name="pabrik04">
                              <option value="">--Pilih--</option>
                              <?php
								$qp4=mysql_query ("SELECT * FROM pbf");
								while ($rp4=mysql_fetch_array($qp4))
								{
									if ($rp4['id'] == $r['pabrik04'])
									{
										echo "<option value='$rp4[id]' selected>$rp4[nama] </option>";
									}
									else
									{
										echo "<option value='$rp4[id]'>$rp4[nama] </option>";
									}
								}
							?>
                            </select>
						...
						<tr>
						  <td align="right"><div align="left">PBF 05 </div></td>
						  <td>:</td>
						  <td><select name="pabrik05">
                              <option value="">--Pilih--</option>
                              <?php
								$qp5=mysql_query ("SELECT * FROM pbf");
								while ($rp5=mysql_fetch_array($qp5))
								{
									if ($rp5['id'] == $r['pabrik05'])
									{
										echo "<option value='$rp5[id]' selected>$rp5[nama] </option>";
									}
									else
									{
										echo "<option value='$rp5[id]'>$rp5[nama] </option>";
									}
								}
							?>
                            </select>
						...
						<tr>
						  <td align="right"><div align="left"><font color="#FF0000">Pabrik Obat*</font></div></td>
						  <td>:</td>
						  <td><select name="pabrik_obat">
                            <option value="">--Pilih--</option>
                            <?php
								$qpo=mysql_query ("SELECT * FROM pabrik");
								while ($rpo=mysql_fetch_array($qpo))
								{
									if ($rpo['kd_pabrik'] == $r['pabrik_obat'])
									{
										echo "<option value='$rpo[kd_pabrik]' selected>$rpo[nama]</option>";
									}
									else
									{
										echo "<option value='$rpo[kd_pabrik]'>$rpo[nama]</option>";
									}
								}
							?>
                          </select></td>
						...
						<tr>
						  ...
						  <td align="right">&nbsp;</td>
							<td align="right"><div align="left"><font color="#FF0000">Status *</font> </div></td>
							<td>:</td>
						...
						<tr>
						  ...
						  <td>Stok</td>
						  <td>:</td>
						  <td><input type="text" name="stok" size="5" value="<?= $r['stok']?>"></td>
						  <?php
						  }
						  else
						  {
