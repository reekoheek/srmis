...
$namaFile = "lap_distribusi_obat.xls";
...
xlsWriteLabel(0,0,"DISTRIBUSI OBAT, Tertanggal : $tgl_mulai - $tgl_selesai")->MergeCells = True;  
...
$query = "SELECT * FROM permintaan_unitdetail,permintaan_unit,pelayanan WHERE permintaan_unit.No_SPP=permintaan_unitdetail.No_SPP AND 
		  permintaan_unitdetail.Unit=pelayanan.id AND permintaan_unitdetail.status_detail <> '0' AND permintaan_unit.create_date BETWEEN '$tanggal_start' AND '$tanggal_end'  
