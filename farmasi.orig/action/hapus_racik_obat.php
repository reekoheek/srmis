...
if($result){
print "<script>alert('Data Berhasil di Hapus.');location.href='home.php?hal=content/racik_obat&fld02=$fld02&no_racik=$no_racik&pasien_id=$pasien_id&id=$id&no_resep=$no_resep&namapas=$namapas&cara_bayar=$cara_bayar&sub_margin=$sub_margin'</script>";
}
