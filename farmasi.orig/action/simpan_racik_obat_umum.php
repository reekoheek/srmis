<?php
	...
	print "<script>alert('Data Telah Di Simpan .');location.href='home.php?hal=content/resep_reg_umum&no_ket=$no_ket&jenis_ket=$jenis_ket&no_resep=$no_resep&no_racik=$no_racik&param_no=$param_no&no_resep=$no_resep&nama=$nama_pas&rs_asal=$rs_asal&sub_margin=$sub_margin'</script>";
?>