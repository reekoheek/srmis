<?php
	...
	$qq=mysql_query("SELECT * FROM ms_barang WHERE id='$id_ms'");
			...
			$hehe=1;
			print "<script>alert('Data Berhasil di APPROVE.');location.href='home.php?hal=content/distribusi_kontrol&No_SPP=$ru[No_SPP]&No_BPB=$No_BPB&Tgl_SPP=$Tgl_SPP'</script>";
