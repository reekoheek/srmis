...
<body>
<script>PopupCenter('preview_resep.php?no_resep=<? echo $no_resep; ?>','myPop1',800,800);</script>
<script>location.href='lihat_resep_rawat_inap2.php?no_trans=<?=$no_trans?>&param_no=<?=$param_no?>'</script>
</body>
</html>
