...
if($r_p_det>0)
{ 
 	$dell=mysql_query("delete from penjualan where  no_trans='$no_trans'");
...
/* $q_pas=mysql_query("select * from pasien where id='$r1[pasien_id]'");
 ...
 print "<script>location.href='home.php?hal=content/kasir_tes&no_trans=$no_trans&no_resep=$no_resep&namapas=$namapas&param_no=$param_no&pasien_id=$pasien_id&unit_id=$unit_id'</script>";
?>