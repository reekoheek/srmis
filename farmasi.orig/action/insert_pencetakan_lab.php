...
?>
<script>PopupCenter('content/cetak_resep_lab.php?no_resep=<? echo $no_resep; ?>&pasien_id=<? echo $pasien_id; ?>&nama=<? echo $nama; ?>','myPop1',800,800);</script>
<script>location.href='home.php?hal=content/resep_reg_lab'</script>
</body >
</html>