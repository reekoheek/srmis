...
(pageURL, title, 'toolbar=no, alwaysraised='+1+', fullScreen=0, locationbar=no, location=0, directories=0, status=no, menubar=0, scrollbars=yes, resizable=0, copyhistory=0, width=300, height=screen.availHeight.MAX_VALUE, top=0, left=200');
...
$tgl1=$_POST['tgl1'];
$tgl2=$_POST['tgl2'];
$shift=$_POST['shift_jml'];
?>
<body>
<script>PopupCenter('content/jml_obat_terpakai.php?tgl1=<? echo $tgl1; ?>&tgl2=<? echo $tgl2; ?>&shift=<? echo $shift; ?>','Laporan Transaksi',300,600);</script>
