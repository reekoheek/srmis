<?php
	...
	//$pwd = $_POST['password'];
	$query = "SELECT * FROM user WHERE nm_user = '$user' AND pwd = '$pwd'";
	...
	if(mysql_num_rows($result) > 0) {
		...
		{
			print "<script>alert('Username atau Password yang anda inputkan SALAH, Silahkan Coba Lagi.');location.href='index.php'</script>";
		}
	}
    /* GLOBAL CONSTANTS */
