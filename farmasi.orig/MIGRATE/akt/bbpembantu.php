...
<title>Akuntansi Rumah Sakit - Buku Besar Pembantu</title>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="60" class="header">Akuntansi - Buku Besar Pembantu</td>
  </tr>
  <tr>
  ...
  <tr>
    <td valign="top" class="content"><div id="keterangan">Sistim Akuntasi Rumah Sakit. BUKU BESAR PEMBANTU. Untuk penambahan Buku Pembantu Hutang PBF/Supplier Obat dan Pasien Rawat Inap - dilakukan secara otomatis. Anda tidak perlu menambahkannya secara manual. Begitu pendaftaran pasien disimpan, akan dibuatkan akun buku bantunya juga. </div>
      <div id="warning">&nbsp;---</div>
        <br/>
    <div id="CollapsiblePanel1" class="CollapsiblePanel">
      <div class="CollapsiblePanelTab" tabindex="0">BUKU BESAR PEMBANTU</div>
      <div class="CollapsiblePanelContent">
        <table width="850" border="0" cellpadding="3" cellspacing="1" class="tableisi">
          ...
          <tr class="promo">
            ...
            <td colspan="5" align="center"><table width="400" border="0" cellspacing="1" cellpadding="3">
                <tr class="sidebar">
                  <td align="center"><a href="/simrs/akt/bbpembantu.php?pageNum_rsBB=0&totalRows_rsBB=6">Awal</a></td>
                  <td align="center"><a href="/simrs/akt/bbpembantu.php?pageNum_rsBB=0&totalRows_rsBB=6">Sebelumnya</a></td>
                  <td align="center">Hal:&nbsp;1 / 1</td>
                  <td align="center"><a href="/simrs/akt/bbpembantu.php?pageNum_rsBB=0&totalRows_rsBB=6">Selanjutnya</a></td>
                  <td align="center"><a href="/simrs/akt/bbpembantu.php?pageNum_rsBB=0&totalRows_rsBB=6">Akhir</a></td>
                </tr>
            </table></td>
          </tr>
          <tr>
            <td width="100" align="center" class="t_head">Akun</td>
            <td width="30" align="center" class="t_head">No</td>
            <td width="100" align="center" class="t_head">Kode</td>
            <td align="left" class="t_head">Nama BB pembantu</td>
            <td align="center" class="t_head">Status</td>
            <td align="right" class="t_head">Saldo Awal</td>
            ...
            <td align="left">Hartono</td>
            <td align="center">PIUTANG</td>
            <td align="right">0,00</td>
            <form id="form1" name="form1" method="post" action="">
              <td align="center"><input name="id_edit" type="hidden" id="id_edit" value="00000011" />
            ...
            <td align="center"></td>
            <td align="center">1</td>
            <td align="center">00000015</td>
            <td align="left">SYARIEF</td>
            <td align="center">PIUTANG</td>
            <td align="right">0,00</td>
            <form id="form1" name="form1" method="post" action="">
              <td align="center"><input name="id_edit" type="hidden" id="id_edit" value="00000015" />
                  <input name="imageField" type="image" id="imageField" src="../images/edit_icon.gif" align="middle" />
              </td>
            </form>
            <form id="form2" name="form2" method="post" action="">
            ...
            <td align="center">00000019</td>
            <td align="left">xxx</td>
            <td align="center">PIUTANG</td>
            <td align="right">0,00</td>
            <form id="form1" name="form1" method="post" action="">
              <td align="center"><input name="id_edit" type="hidden" id="id_edit" value="00000019" />
                  <input name="imageField" type="image" id="imageField" src="../images/edit_icon.gif" align="middle" />
              </td>
            </form>
            <form id="form2" name="form2" method="post" action="">
            ...
            <td align="center">00000026</td>
            <td align="left">erwin</td>
            <td align="center">PIUTANG</td>
            <td align="right">0,00</td>
            <form id="form1" name="form1" method="post" action="">
              <td align="center"><input name="id_edit" type="hidden" id="id_edit" value="00000026" />
                  <input name="imageField" type="image" id="imageField" src="../images/edit_icon.gif" align="middle" />
              </td>
            </form>
            <form id="form2" name="form2" method="post" action="">
            ...
            <td align="center">1</td>
            <td align="center">SP0001</td>
            <td align="left">Farma Konima</td>
            <td align="center">Hutang</td>
            <td align="right">0,00</td>
            <form id="form1" name="form1" method="post" action="">
              <td align="center"><input name="id_edit" type="hidden" id="id_edit" value="SP0001" />
                  <input name="imageField" type="image" id="imageField" src="../images/edit_icon.gif" align="middle" />
              </td>
            </form>
            <form id="form2" name="form2" method="post" action="">
            ...
            <td align="center"></td>
            <td align="center">2</td>
            <td align="center">SP0002</td>
            <td align="left">Kimia Farma</td>
            <td align="center">Hutang</td>
            <td align="right">0,00</td>
            <form id="form1" name="form1" method="post" action="">
              <td align="center"><input name="id_edit" type="hidden" id="id_edit" value="SP0002" />
                  <input name="imageField" type="image" id="imageField" src="../images/edit_icon.gif" align="middle" />
              </td>
            </form>
            <form id="form2" name="form2" method="post" action="">
          ...
          <tr class="t_head">
            <td colspan="2" align="left">Jml Data:6</td>
            <td colspan="5" align="center"><table width="400" border="0" cellspacing="1" cellpadding="3">
                <tr class="sidebar">
                  <td align="center"><a href="/simrs/akt/bbpembantu.php?pageNum_rsBB=0&totalRows_rsBB=6">Awal</a></td>
                  <td align="center"><a href="/simrs/akt/bbpembantu.php?pageNum_rsBB=0&totalRows_rsBB=6">Sebelumnya</a></td>
