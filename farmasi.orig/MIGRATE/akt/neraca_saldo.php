...
<title>Akuntansi Rumah Sakit - Neraca Saldo</title>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="60" class="header">Akuntansi - Neraca Saldo</td>
  </tr>
  <tr>
  ...
  <tr>
    <td valign="top" class="content"><div id="keterangan">Sistim Akuntasi Rumah Sakit. Daftar Neraca Saldo.</div>
      <br/><div class="navLink" style="width: 200px;"><a href="?filter=1">FILTER/SARING DATA</a></div>
          <br/>
    <div id="Accordion1" class="Accordion" tabindex="0">
      <div class="AccordionPanel">
        <div class="AccordionPanelTab">NERACA SALDO</div>
        <div class="CollapsiblePanelContent">          
        <table border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF"  class="tableisi">
            <tr>
              <td width="50" rowspan="2" align="center" valign="top" class="tableisi">Kode Akun</td>
              <td width="285" rowspan="2" align="left" valign="top" nowrap="nowrap" class="tableisi">Nama Akun</td>
              <td width="40" rowspan="2" align="center" valign="top" class="tableisi">Pos Saldo</td>
              <td colspan="2" align="center" valign="top" class="tableisi">Neraca Saldo</td>
              <td width="40" rowspan="2" align="center" valign="top" class="tableisi">Pos Lap.</td>
              <td colspan="2" align="center" valign="top" class="tableisi">Laba Rugi</td>
              <td colspan="2" align="center" valign="top" class="tableisi">Neraca</td>
            </tr>
            <tr>
              <td width="130" align="center" class="tableisi">Debet</td>
              <td width="130" align="center" class="tableisi">Kredit</td>
              <td width="130" align="center" class="tableisi">Debet</td>
              <td width="130" align="center" class="tableisi">Kredit</td>
              <td width="130" align="center" class="tableisi">Debet</td>
              <td width="130" align="center" class="tableisi">Kredit</td>
        ...
        <table border="0" cellpadding="3" cellspacing="1" class="tableisi">
            <tr>
              ...
              <td width="135" align="right" valign="top" nowrap="nowrap"></td>
              <td width="135" align="right" valign="top" nowrap="nowrap"></td>
              <td width="40" align="center" valign="top" nowrap="nowrap"></td>
              <td width="135" align="right" valign="top" nowrap="nowrap"></td>
              <td width="135" align="right" valign="top" nowrap="nowrap"></td>
              <td width="135" align="right" valign="top" nowrap="nowrap"></td>
              <td width="135" align="right" valign="top" nowrap="nowrap"></td>
            ...
            <tr >
              <td colspan="3" align="left" bgcolor="#FFFFFF" class="t_foot">Jumlah</td>
              <td align="right" bgcolor="#FFFFFF" class="t_foot">0</td>
              <td align="right" bgcolor="#FFFFFF" class="t_foot">0</td>
              <td align="center" bgcolor="#FFFFFF" class="t_foot">&nbsp;</td>
              <td align="right" bgcolor="#FFFFFF" class="t_foot">0</td>
              <td align="right" bgcolor="#FFFFFF" class="t_foot">0</td>
              <td align="right" bgcolor="#FFFFFF" class="t_foot">0</td>
              <td align="right" bgcolor="#FFFFFF" class="t_foot">0</td>
            ...
            <tr >
              <td colspan="6" align="left" bgcolor="#FFFFFF" class="t_foot">RL Bersih</td>
              <td colspan="2" align="right" bgcolor="#FFFFFF" class="t_foot">0</td>
              <td colspan="2" align="right" bgcolor="#FFFFFF" class="t_foot">0</td>
            </tr>
            <tr >
              <td colspan="8" align="left" bgcolor="#FFFFFF" class="t_foot">Jumlah</td>
              <td align="right" bgcolor="#FFFFFF" class="t_foot">0</td>
              <td align="right" bgcolor="#FFFFFF" class="t_foot">0</td>
            </tr>
            </table>
...
<br />
<b>Warning</b>:  mysql_free_result(): supplied argument is not a valid MySQL result resource in <b>/home/juragans/public_html/simrs/akt/neraca_saldo.php</b> on line <b>282</b><br />
