...
<title>Akuntansi Rumah Sakit - Buku Besar Pembantu Hutang</title>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="60" class="header">Akuntansi - Buku Besar Pembantu Hutang</td>
  </tr>
  <tr>
  ...
  <tr>
    <td valign="top" class="content"><div class="fields">
    <fieldset>
    <legend>Kriteria :</legend>
    <form id="form3" name="form3" method="post" action="">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF" class="tableisi">
        <tr>
          <td width="40%" class="row_alt2">Bulan </td>
          <td align="left"><label for="bulan"></label>
              <select name="bulan">
        ...
        <tr>
          <td class="row_alt2">Tahun</td>
          <td align="left"><input name="tahun" type="text" class="small" id="tahun" value="2011" size="45" /></td>
        </tr>
        <tr>
          <td class="row_alt2">Status</td>
          <td align="left">HUTANG</td>
        </tr>
        <tr>
          <td class="row_alt2">Nama Relasi</td>
          <td align="left"><label for="nama"></label>
            <select name="nama" id="nama">
                            <option value="SP0001">SP0001 | Farma Konima</option>              <option value="SP0002">SP0002 | Kimia Farma</option>            </select></td>
        </tr>
        <tr>
          <td class="row_alt2"><input name="newId" type="hidden" id="newId" value="83875" /></td>
    ...
    <div id="Accordion1" class="Accordion" tabindex="0">
      <div class="AccordionPanel">
              <div class="AccordionPanelTab">Daftar BB. Pembantu Hutang</div>
        <div class="CollapsiblePanelContent">
          <table border="0" cellpadding="3" cellspacing="1" class="tableisi">
            <tr>
              <td width="80" align="center" class="t_head">Tanggal</td>
              <td width="140" align="left" class="t_head">Bukti</td>
              <td width="400" align="left" class="t_head">Keterangan</td>
              <td width="120" align="left" class="t_head">Debet</td>
              <td width="120" align="left" class="t_head">Kredit</td>
              </tr>
            <tr>
              <td colspan="4" align="right" class="t_head">Saldo Awal</td>
              <td align="right" class="dingbat">0</td>
            </tr>
          </table>
        </div>
      </div>
...
<table border="0" cellpadding="3" cellspacing="1" class="tableisi">
              ...
              <td align="right" class="tableisi">0</td>
              <td align="right" class="tableisi">0</td>
            </tr>
            <tr class="t_foot">
              <td colspan="4" align="right">Saldo Akhir&nbsp;&nbsp;</td>
              <td align="right" class="dingbat">0</td>
            </tr>
          </table>
        </div>
