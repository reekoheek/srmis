...
<title>Akuntansi Rumah Sakit - Golongan Persediaan</title>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td height="60" class="header">Akuntansi - Penentuan Periode Akuntansi</td>
  </tr>
  <tr>
  ...
  <tr>
    <td valign="top" class="content"><div id="keterangan">Sistim Akuntasi Rumah Sakit. Periode Awal adalah: Januari 2010</div>
      <div class="fields">
    <fieldset>
    <legend>Penentuan Periode Pembukuan Awal</legend>
    
    <form id="f_periode" name="f_periode" method="POST" action="/simrs/akt/periode.php?">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#FFFFFF" class="tableisi">
        ...
        <tr>
          ...
          <td align="left"><label for="tahun"></label>
            <input type="text" name="tahun" id="tahun" value="2010" /></td>
        </tr>
        <tr>
          <td class="row_alt2">&nbsp;</td>
          <td align="center"><input name="key" type="hidden" id="key" value="1" /></td>
        </tr>
        <tr>
          <td class="row_alt2">&nbsp;</td>
      ...
      <input type="hidden" name="MM_update" value="f_periode" />
    </form>
    </fieldset>
    </div>
